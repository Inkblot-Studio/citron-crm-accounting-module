...
import { g as CRM_TOOLBAR_SURFACE, b as CRM_TOOLBAR_SEARCH_WRAP } from './crmToolbarClasses-DO0dkTie.js';
import { u as useOfferStore, d as draftGrandTotal, a as draftCurrency, f as formatMoney, N as NEW_OFFER_ROUTE } from './offerStore-DjzPSng9.js';
...
function OffersHome() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-full min-w-0 px-3 min-[400px]:px-4 sm:px-6 lg:px-8 py-4 sm:py-6 pb-[max(1.25rem,env(safe-area-inset-bottom,0px))] sm:pb-6 overflow-y-auto hide-scrollbar h-full box-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mb-4 ${CRM_TOOLBAR_SURFACE}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex-1 min-w-0 [&_label]:sr-only ${CRM_TOOLBAR_SEARCH_WRAP}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        SearchBar,
        {
          label: "Search offers",
    ...
    filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-3 rounded-xl border border-border/50 bg-muted/15 px-6 py-14 text-center dark:bg-muted/10", children: [
