...
Best regards,
[Your name]`,Ma=[{id:"1",campaignName:"Q1 Product Launch",recipients:"2840 recipients",status:"sent",opens:"68%",clicks:"24%",date:"Feb 12, 2026"},{id:"2",campaignName:"Welcome Series",recipients:"1200 recipients",status:"active",statusSubtext:"Running",opens:"-",clicks:"-",date:"Feb 28, 2026"},{id:"3",campaignName:"Re-engagement Campaign",recipients:"890 recipients",status:"draft",opens:"-",clicks:"-",date:"Feb 5, 2026"},{id:"4",campaignName:"Holiday Promo",recipients:"4500 recipients",status:"scheduled",opens:"-",clicks:"-",date:"Mar 1, 2026"}],Ea=[{id:"1",category:"Onboarding",title:"Welcome Series",uses:"34 uses"},{id:"2",category:"Marketing",title:"Product Announcement",uses:"12 uses"},{id:"3",category:"Retention",title:"Renewal Reminder",uses:"28 uses"},{id:"4",category:"Sales",title:"Meeting Follow-up",uses:"56 uses"}],Ia=["Acme Corp - Sarah Chen","TechStart Inc - Mike Rodriguez","GlobalTech - Lisa Kim","Enterprise Co - John Smith","StartupXYZ - Emma Wilson"],mc=[{key:"campaign",label:"Campaign"},{key:"status",label:"Status"},{key:"opens",label:"Opens"},{key:"clicks",label:"Clicks"},{key:"date",label:"Date"}],pc=[{label:"Total Sent",value:"12.4K",change:"This month",changeVariant:"success"},{label:"Avg. Open Rate",value:"64%",change:"+8% vs prior",changeVariant:"success"},{label:"Avg. Click Rate",value:"22%",change:"+3% vs prior",changeVariant:"success"},{label:"Active Automations",value:"7",change:"3 paused",changeVariant:"error"}];function La({onSendNow:t,onSchedule:e,onSaveDraft:r,onNewCampaign:a,onGenerateWithAI:i,onTemplateClick:n,className:s}){let[l,c]=se("campaigns"),[d,m]=se(""),[p,b]=se(""),[u,f]=se(""),[w,h]=se(false),[g,P]=se(""),N=Zr(()=>{if(!d.trim())return Ma;let E=d.toLowerCase();return Ma.filter(F=>F.campaignName.toLowerCase().includes(E)||F.recipients.toLowerCase().includes(E))},[d]),y=Zr(()=>{if(!d.trim())return Ea;let E=d.toLowerCase();return Ea.filter(F=>F.title.toLowerCase().includes(E)||F.category.toLowerCase().includes(E))},[d]),k=Zr(()=>{if(!g.trim())return Ia;let E=g.toLowerCase();return Ia.filter(F=>F.toLowerCase().includes(E))},[g]),v=async()=>{h(true),await new Promise(E=>setTimeout(E,1500)),f(dc),h(false);},x=()=>{t?.();},C=()=>{e?.();},S=()=>{r?.();},D=l==="campaigns"||l==="templates";return jsxRuntimeExports.jsx("div",{className:o("flex min-h-screen flex-col bg-[var(--inkblot-semantic-color-background-primary)]",s),children:jsxRuntimeExports.jsxs("div",{className:"flex flex-1 flex-col gap-[var(--inkblot-spacing-8)] px-[var(--inkblot-spacing-8)] py-[var(--inkblot-spacing-8)]",children:[jsxRuntimeExports.jsx(ee,{title:"Email Campaigns",subtitle:"Automate outreach \xB7 AI-powered templates",icon:jsxRuntimeExports.jsx(Mail,{className:"h-5 w-5"}),action:jsxRuntimeExports.jsx(re,{label:"New Campaign",onClick:()=>a?.()})}),jsxRuntimeExports.jsx(er,{tabs:[{id:"campaigns",label:"Campaigns"},{id:"templates",label:"Templates"},{id:"compose",label:"Compose"}],activeTabId:l,onTabChange:c}),D?jsxRuntimeExports.jsx(Tt,{placeholder:l==="campaigns"?"Search campaigns...":"Search templates...",value:d,onChange:E=>m(E.target.value)}):null,l==="campaigns"?jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:[jsxRuntimeExports.jsx(tr,{items:pc}),jsxRuntimeExports.jsx(Ke,{columns:mc,rows:N})]}):l==="templates"?jsxRuntimeExports.jsx(Ue,{templates:y,onGenerateWithAI:i,onTemplateClick:n}):jsxRuntimeExports.jsxs("div",{className:"flex max-w-2xl flex-col gap-[var(--inkblot-spacing-6)] rounded-[var(--inkblot-radius-xl)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] p-[var(--inkblot-spacing-6)] shadow-[var(--inkblot-shadow-sm)]",children:[jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-6)]",children:[jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("label",{className:"uppercase tracking-wider text-[var(--inkblot-semantic-color-text-primary)] [font:var(--inkblot-semantic-typography-body-small)]",children:"Subject"}),jsxRuntimeExports.jsx(Vt,{type:"text",value:p,onChange:E=>b(E.target.value),placeholder:"Enter subject line..."})]}),jsxRuntimeExports.jsx(ge,{label:"Body",value:u,onChange:E=>f(E.target.value),placeholder:"Compose your email or let AI generate content...",loading:w,onWriteWithAI:v}),jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx(Tt,{label:"Recipients",placeholder:"Search contacts, segments, or tags...",value:g,onChange:E=>P(E.target.value)}),k.length>0?jsxRuntimeExports.jsx("ul",{className:"flex flex-wrap gap-[var(--inkblot-spacing-2)]",children:k.slice(0,5).map(E=>jsxRuntimeExports.jsx("li",{className:o("rounded-[var(--inkblot-radius-md)]","bg-[var(--inkblot-semantic-color-background-secondary)]","px-[var(--inkblot-spacing-2)] py-[var(--inkblot-spacing-1)]","[font:var(--inkblot-semantic-typography-body-small)]","text-[var(--inkblot-semantic-color-text-secondary)]"),children:E},E))}):null]})]}),jsxRuntimeExports.jsx(Ge,{onSendNow:x,onSchedule:C,onSaveDraft:S})]})]})})}const {createContext:uc,useCallback:Aa,useContext:vc,useEffect:fc,useLayoutEffect:gc,useMemo:kc,useState:Da} = await importShared('react');
var br="citron-ui-theme",Ha=uc(null);function yc(){if(typeof window>"u")return null;try{let t=window.localStorage.getItem(br);if(t==="light"||t==="dark")return t}catch{}return null}function xc(){return typeof window>"u"?"light":window.matchMedia?.("(prefers-color-scheme: dark)").matches?"dark":"light"}function Ra(t){typeof document>"u"||document.documentElement.setAttribute("data-theme",t);}function Ba({children:t}){let[e,r]=Da("light"),[a,i]=Da(false);gc(()=>{if(typeof window>"u")return;let d=yc()??xc();r(d),Ra(d),i(true);},[]),fc(()=>{if(a&&(Ra(e),!(typeof window>"u")))try{window.localStorage.setItem(br,e);}catch{}},[e,a]);let n=Aa(c=>{r(c);},[]),s=Aa(()=>{r(c=>c==="light"?"dark":"light");},[]),l=kc(()=>({theme:e,setTheme:n,toggleTheme:s}),[e,n,s]);return jsxRuntimeExports.jsx(Ha.Provider,{value:l,children:t})}function ur(){let t=vc(Ha);if(!t)throw new Error("useTheme must be used within a ThemeProvider");return t}function vr({className:t,type:e="button",...r}){let{theme:a,toggleTheme:i}=ur(),n=a==="dark",s=n?Sun:Moon;return jsxRuntimeExports.jsx("button",{type:e,onClick:i,"aria-label":n?"Switch to light mode":"Switch to dark mode","aria-pressed":n,className:o("group relative inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[var(--inkblot-radius-md)] border border-transparent","text-[var(--inkblot-semantic-color-text-tertiary)] transition-colors duration-[var(--inkblot-duration-fast)]","hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] hover:text-[var(--inkblot-semantic-color-text-primary)]","focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--inkblot-semantic-color-border-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--inkblot-semantic-color-background-primary)]",t),...r,children:jsxRuntimeExports.jsx(s,{className:"h-[18px] w-[18px] shrink-0",strokeWidth:2,"aria-hidden":true})})}const {forwardRef:Cc} = await importShared('react');
const {NavLink:Tc} = await importShared('react-router-dom');
var Qr=Cc(({className:t,activeClassName:e,pendingClassName:r,...a},i)=>jsxRuntimeExports.jsx(Tc,{ref:i,className:({isActive:n,isPending:s})=>o(t,n&&e,s&&r),...a}));Qr.displayName="NavLinkRouter";const {useState:za,useRef:Sc,useEffect:Mc} = await importShared('react');
var gr=o("min-h-[var(--inkblot-size-touch-target-min)] w-full rounded-[var(--inkblot-radius-md)]","border border-[var(--inkblot-semantic-color-border-default)]","bg-[var(--inkblot-semantic-color-background-primary)]","px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)]","[font:var(--inkblot-semantic-typography-body-small)]","text-[var(--inkblot-semantic-color-text-primary)] placeholder:text-[var(--inkblot-semantic-color-text-tertiary)]","transition-colors duration-[var(--inkblot-duration-fast)]","focus:outline-none focus:ring-2 focus:ring-[var(--inkblot-semantic-color-border-focus)]"),Et=o("[font:var(--inkblot-semantic-typography-body-small)] font-medium","text-[var(--inkblot-semantic-color-text-secondary)]"),Va="border-[var(--inkblot-semantic-color-status-error)]";function Fa({items:t,value:e,onChange:r,placeholder:a,hasError:i,onCreateNew:n,createNewLabel:s}){let[l,c]=za(""),[d,m]=za(false),p=Sc(null);Mc(()=>{let f=w=>{p.current&&!p.current.contains(w.target)&&m(false);};return document.addEventListener("mousedown",f),()=>document.removeEventListener("mousedown",f)},[]);let b=t.find(f=>f.id===e),u=t.filter(f=>f.name.toLowerCase().includes(l.toLowerCase()));return jsxRuntimeExports.jsxs("div",{ref:p,className:"relative",children:[jsxRuntimeExports.jsx("input",{type:"text",value:d?l:b?.name??"",onChange:f=>{c(f.target.value),d||m(true);},onFocus:()=>{m(true),c("");},placeholder:a,className:o(gr,i&&!e&&Va)}),d&&jsxRuntimeExports.jsxs("div",{className:o("absolute z-50 mt-[var(--inkblot-spacing-1)] max-h-48 w-full overflow-auto","rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)]","bg-[var(--inkblot-semantic-color-background-primary)] shadow-[var(--inkblot-shadow-sm)]"),children:[u.map(f=>jsxRuntimeExports.jsx("button",{type:"button",onClick:()=>{r(f.id),m(false),c("");},className:o("w-full px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)] text-left","[font:var(--inkblot-semantic-typography-body-small)]","text-[var(--inkblot-semantic-color-text-primary)]","transition-colors duration-[var(--inkblot-duration-fast)]","hover:bg-[var(--inkblot-semantic-color-background-tertiary)]",f.id===e&&"bg-[var(--inkblot-semantic-color-background-tertiary)]"),children:f.name},f.id)),u.length===0&&!n&&jsxRuntimeExports.jsx("div",{className:o("px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-3)]","[font:var(--inkblot-semantic-typography-body-small)]","text-[var(--inkblot-semantic-color-text-tertiary)]"),children:"No results"}),n&&u.length===0&&jsxRuntimeExports.jsxs("button",{type:"button",onClick:()=>{n(),m(false);},className:o("flex w-full items-center gap-[var(--inkblot-spacing-2)]","px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)]","[font:var(--inkblot-semantic-typography-body-small)] font-medium","text-[var(--inkblot-semantic-color-interactive-primary)]","transition-colors duration-[var(--inkblot-duration-fast)]","hover:bg-[var(--inkblot-semantic-color-background-tertiary)]"),children:[jsxRuntimeExports.jsx(Plus,{className:"h-4 w-4"}),s??"Create new"]})]})]})}function fr({options:t,value:e,onChange:r,placeholder:a}){return jsxRuntimeExports.jsxs("div",{className:"relative",children:[jsxRuntimeExports.jsxs("select",{value:e,onChange:i=>r(i.target.value),className:o(gr,"appearance-none pr-[var(--inkblot-spacing-8)]"),children:[jsxRuntimeExports.jsx("option",{value:"",children:a}),t.map(i=>jsxRuntimeExports.jsx("option",{value:i,children:i},i))]}),jsxRuntimeExports.jsx(ChevronDown,{className:o("pointer-events-none absolute right-[var(--inkblot-spacing-3)] top-1/2 h-4 w-4 -translate-y-1/2","text-[var(--inkblot-semantic-color-text-tertiary)]")})]})}var Lc=["Bank Transfer","Credit Card","Cash","Check"],Ac=["VAT 21%","VAT 10%","VAT 0%","Exempt"],Dc=["Standard","Proforma","Credit Note","Debit Note"],Rc=["Main Account","Secondary Account"];function Jr({clients:t,products:e,paymentMethods:r=Lc,taxTypes:a=Ac,invoiceTypes:i=Dc,bankAccounts:n=Rc,value:s={},onChange:l,onCreateClient:c,attempted:d=false,className:m}){let p=b=>l?.({...s,...b});return jsxRuntimeExports.jsxs("div",{className:o("grid grid-cols-1 gap-[var(--inkblot-spacing-4)] md:grid-cols-2",m),children:[jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("label",{className:Et,children:"Client"}),jsxRuntimeExports.jsx(Fa,{items:t,value:s.clientId??"",onChange:b=>p({clientId:b}),placeholder:"Search client...",hasError:d,onCreateNew:c,createNewLabel:"+ Create new client"})]}),jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("label",{className:Et,children:"Product / Service"}),jsxRuntimeExports.jsx(Fa,{items:e,value:s.productId??"",onChange:b=>p({productId:b}),placeholder:"Search product...",hasError:d})]}),jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("label",{className:Et,children:"Quantity"}),jsxRuntimeExports.jsx("input",{type:"number",min:1,value:s.quantity??"",onChange:b=>p({quantity:b.target.value===""?0:Number(b.target.value)}),placeholder:"1",className:o(gr,d&&!s.quantity&&Va)})]}),jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("label",{className:Et,children:"Payment Method"}),jsxRuntimeExports.jsx(fr,{options:r,value:s.paymentMethod??"",onChange:b=>p({paymentMethod:b}),placeholder:"Select..."})]}),jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("label",{className:Et,children:"Tax Type"}),jsxRuntimeExports.jsx(fr,{options:a,value:s.taxType??"",onChange:b=>p({taxType:b}),placeholder:"Select..."})]}),jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("label",{className:Et,children:"Invoice Type"}),jsxRuntimeExports.jsx(fr,{options:i,value:s.invoiceType??"",onChange:b=>p({invoiceType:b}),placeholder:"Select..."})]}),jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("label",{className:Et,children:"Bank Account"}),jsxRuntimeExports.jsx(fr,{options:n,value:s.bankAccount??"",onChange:b=>p({bankAccount:b}),placeholder:"Select..."})]}),jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-[var(--inkblot-spacing-2)] md:col-span-2",children:[jsxRuntimeExports.jsx("label",{className:Et,children:"Notes"}),jsxRuntimeExports.jsx("textarea",{value:s.notes??"",onChange:b=>p({notes:b.target.value}),rows:3,placeholder:"Additional notes...",className:o(gr,"resize-y")})]})]})}function vt({label:t,value:e}){return jsxRuntimeExports.jsxs("div",{className:"flex items-baseline justify-between border-b border-[var(--inkblot-semantic-color-border-default)] py-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("span",{className:"[font:var(--inkblot-semantic-typography-body-small)] text-[var(--inkblot-semantic-color-text-tertiary)]",children:t}),jsxRuntimeExports.jsx("span",{className:"[font:var(--inkblot-semantic-typography-body-small)] text-[var(--inkblot-semantic-color-text-primary)]",children:e||"\u2014"})]})}function eo({data:t,clients:e,products:r,className:a}){let i=e.find(d=>d.id===t.clientId),n=r.find(d=>d.id===t.productId),s=t.quantity??0,l=n?.unitPrice??0,c=s*l;return jsxRuntimeExports.jsxs("div",{className:o("rounded-[var(--inkblot-radius-xl)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-primary)] p-[var(--inkblot-spacing-6)]",a),children:[jsxRuntimeExports.jsx("h3",{className:"mb-[var(--inkblot-spacing-4)] [font:var(--inkblot-semantic-typography-heading-4)] text-[var(--inkblot-semantic-color-text-primary)]",children:"Preview"}),jsxRuntimeExports.jsxs("div",{className:"space-y-0",children:[jsxRuntimeExports.jsx(vt,{label:"Client",value:i?.name??""}),jsxRuntimeExports.jsx(vt,{label:"Product",value:n?.name??""}),jsxRuntimeExports.jsx(vt,{label:"Quantity",value:s?String(s):""}),l>0&&jsxRuntimeExports.jsx(vt,{label:"Unit price",value:`$${l.toFixed(2)}`}),c>0&&jsxRuntimeExports.jsx(vt,{label:"Subtotal",value:`$${c.toFixed(2)}`}),jsxRuntimeExports.jsx(vt,{label:"Payment",value:t.paymentMethod??""}),jsxRuntimeExports.jsx(vt,{label:"Tax",value:t.taxType??""}),jsxRuntimeExports.jsx(vt,{label:"Type",value:t.invoiceType??""}),jsxRuntimeExports.jsx(vt,{label:"Bank",value:t.bankAccount??""})]}),t.notes&&jsxRuntimeExports.jsx("p",{className:"mt-[var(--inkblot-spacing-4)] [font:var(--inkblot-semantic-typography-body-small)] text-[var(--inkblot-semantic-color-text-secondary)]",children:t.notes})]})}const {useState:Ga} = await importShared('react');
function Bc({clients:t,products:e,onSubmit:r,onCreateClient:a,isSubmitting:i=false,className:n,...s}){let[l,c]=Ga({}),[d,m]=Ga(false);return jsxRuntimeExports.jsxs("form",{onSubmit:b=>{b.preventDefault(),m(true),!(!l.clientId||!l.productId||!l.quantity)&&r?.({clientId:l.clientId,productId:l.productId,quantity:l.quantity,paymentMethod:l.paymentMethod??"",taxType:l.taxType??"",invoiceType:l.invoiceType??"",bankAccount:l.bankAccount??"",notes:l.notes??""});},className:o("rounded-[var(--inkblot-radius-xl)] bg-[var(--inkblot-semantic-color-background-secondary)] p-[var(--inkblot-spacing-6)]",n),children:[jsxRuntimeExports.jsx("h2",{className:"mb-[var(--inkblot-spacing-6)] [font:var(--inkblot-semantic-typography-heading-4)] text-[var(--inkblot-semantic-color-text-primary)]",children:"New Invoice"}),jsxRuntimeExports.jsxs("div",{className:"grid grid-cols-1 gap-[var(--inkblot-spacing-6)] lg:grid-cols-[1fr_20rem]",children:[jsxRuntimeExports.jsx(Jr,{clients:t,products:e,value:l,onChange:c,onCreateClient:a,attempted:d,...s}),jsxRuntimeExports.jsx(eo,{data:l,clients:t,products:e})]}),jsxRuntimeExports.jsx("div",{className:"mt-[var(--inkblot-spacing-6)] flex justify-end",children:jsxRuntimeExports.jsxs("button",{type:"submit",disabled:i,className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center gap-[var(--inkblot-spacing-2)]","rounded-[var(--inkblot-radius-lg)]","bg-[var(--inkblot-semantic-color-interactive-primary)]","px-[var(--inkblot-spacing-6)] py-[var(--inkblot-spacing-2)]","[font:var(--inkblot-semantic-typography-body-small)] font-medium","text-[var(--inkblot-semantic-color-text-inverse)]","transition-colors duration-[var(--inkblot-duration-fast)]","hover:bg-[var(--inkblot-semantic-color-interactive-primary-hover)]","active:bg-[var(--inkblot-semantic-color-interactive-primary-active)]","focus:outline-none focus:ring-2 focus:ring-[var(--inkblot-semantic-color-border-focus)]","disabled:opacity-[var(--inkblot-opacity-disabled)] disabled:cursor-not-allowed"),children:[i&&jsxRuntimeExports.jsx(LoaderCircle,{className:"h-4 w-4 animate-spin"}),"Create Invoice"]})})]})}const {useMemo:Oc,useState:zc} = await importShared('react');
function Vc({items:t,defaultValue:e,allowMultiple:r=false,className:a}){let i=Oc(()=>new Set(e??[]),[e]),[n,s]=zc(i),l=c=>{s(d=>{let m=new Set(d);return m.has(c)?(m.delete(c),m):r?(m.add(c),m):new Set([c])});};return jsxRuntimeExports.jsx("div",{className:o("w-full overflow-hidden rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)]",a),children:t.map((c,d)=>{let m=n.has(c.id);return jsxRuntimeExports.jsxs("div",{className:o(d!==0&&"border-t border-[var(--inkblot-semantic-color-border-default)]"),children:[jsxRuntimeExports.jsxs("button",{type:"button",disabled:c.disabled,"aria-expanded":m,onClick:()=>l(c.id),className:o("flex min-h-[var(--inkblot-size-touch-target-min)] w-full items-center justify-between gap-[var(--inkblot-spacing-3)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-3)] text-left text-[var(--inkblot-semantic-color-text-primary)] transition-colors duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)]",c.disabled?"cursor-not-allowed opacity-[var(--inkblot-opacity-disabled)]":"hover:bg-[var(--inkblot-semantic-color-background-tertiary)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--inkblot-semantic-color-border-focus)] focus-visible:outline-offset-[-2px]"),children:[jsxRuntimeExports.jsx("span",{className:"font-medium",children:c.title}),jsxRuntimeExports.jsx(ChevronDown,{className:o("h-4 w-4 shrink-0 text-[var(--inkblot-semantic-color-text-tertiary)] transition-transform duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)]",m&&"rotate-180")})]}),m&&jsxRuntimeExports.jsx("div",{className:"px-[var(--inkblot-spacing-4)] pb-[var(--inkblot-spacing-4)] text-sm text-[var(--inkblot-semantic-color-text-secondary)]",children:c.content})]},c.id)})})}const {useCallback:Gc,useEffect:yr,useRef:Se,useState:ce} = await importShared('react');
function $c({options:t=[],loadOptions:e,value:r,defaultValue:a,onChange:i,placeholder:n="Select an option",searchPlaceholder:s="Search...",emptyMessage:l="No results found",loadingMessage:c="Loading...",clearable:d=false,disabled:m=false,className:p}){let b=r!==void 0,[u,f]=ce(a??null),w=b?r:u,[h,g]=ce(false),[P,N]=ce(""),[y,k]=ce(-1),[v,x]=ce([]),[C,S]=ce(false),D=Se(null),E=Se(0),F=e!==void 0,I=F?v:t,O=Se(null),L=Se(null),W=Se(null);yr(()=>{if(!(!F||!h))return D.current&&clearTimeout(D.current),D.current=setTimeout(()=>{let T=++E.current;S(true),e(P).then(q=>{T===E.current&&(x(q),S(false),k(-1));}).catch(()=>{T===E.current&&(x([]),S(false));});},250),()=>{D.current&&clearTimeout(D.current);}},[P,h,F,e]);let $=F?I:I.filter(T=>T.label.toLowerCase().includes(P.toLowerCase())),qt=I.find(T=>T.value===w)??(F?t.find(T=>T.value===w):void 0),Yt=Gc(T=>{b||f(T),i?.(T),g(false),N(""),k(-1);},[b,i]);yr(()=>{if(!h)return;let T=q=>{O.current&&!O.current.contains(q.target)&&(g(false),N(""),k(-1));};return document.addEventListener("mousedown",T),()=>document.removeEventListener("mousedown",T)},[h]),yr(()=>{h&&W.current?.focus();},[h]),yr(()=>{if(y<0||!L.current)return;L.current.querySelectorAll("[data-option]")[y]?.scrollIntoView({block:"nearest"});},[y]);let Er=T=>{if(!h){(T.key==="Enter"||T.key===" "||T.key==="ArrowDown")&&(T.preventDefault(),g(true));return}switch(T.key){case "ArrowDown":{T.preventDefault(),k(q=>{let U=q+1;for(;U<$.length&&$[U].disabled;)U++;return U<$.length?U:q});break}case "ArrowUp":{T.preventDefault(),k(q=>{let U=q-1;for(;U>=0&&$[U].disabled;)U--;return U>=0?U:q});break}case "Enter":{T.preventDefault(),y>=0&&y<$.length&&!$[y].disabled&&Yt($[y].value);break}case "Escape":{T.preventDefault(),g(false),N(""),k(-1);break}}};return jsxRuntimeExports.jsxs("div",{ref:O,className:o("relative w-full",p),onKeyDown:Er,children:[jsxRuntimeExports.jsxs("button",{type:"button",disabled:m,"aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>{m||g(T=>!T);},className:o("flex min-h-[var(--inkblot-size-touch-target-min)] w-full items-center justify-between gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-md)] border px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)]","bg-[var(--inkblot-semantic-color-background-secondary)] text-[var(--inkblot-semantic-color-text-primary)]","transition-[border-color,box-shadow] duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)]","border-[var(--inkblot-semantic-color-border-default)] hover:border-[var(--inkblot-semantic-color-border-strong)]","focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--inkblot-semantic-color-border-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--inkblot-semantic-color-background-primary)]",m&&"pointer-events-none cursor-not-allowed opacity-[var(--inkblot-opacity-disabled)]"),children:[jsxRuntimeExports.jsx("span",{className:o("truncate text-left",!qt&&"text-[var(--inkblot-semantic-color-text-tertiary)]"),children:qt?qt.label:n}),jsxRuntimeExports.jsxs("span",{className:"flex shrink-0 items-center gap-[var(--inkblot-spacing-1)]",children:[d&&qt&&jsxRuntimeExports.jsx("span",{role:"button",tabIndex:0,"aria-label":"Clear selection",onClick:T=>{T.stopPropagation(),Yt(null);},onKeyDown:T=>{T.key==="Enter"&&(T.stopPropagation(),Yt(null));},className:o("flex items-center justify-center rounded-[var(--inkblot-radius-sm)] p-[var(--inkblot-spacing-1)]","text-[var(--inkblot-semantic-color-text-tertiary)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] hover:text-[var(--inkblot-semantic-color-text-primary)]","transition-colors duration-[var(--inkblot-duration-fast)]"),children:jsxRuntimeExports.jsx(X,{className:"size-3.5"})}),jsxRuntimeExports.jsx(ChevronDown,{"aria-hidden":true,className:o("size-4 text-[var(--inkblot-semantic-color-text-tertiary)] transition-transform duration-[var(--inkblot-duration-fast)]",h&&"rotate-180")})]})]}),jsxRuntimeExports.jsxs("div",{className:o("absolute left-0 top-full z-50 mt-[var(--inkblot-spacing-1)] w-full overflow-hidden rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-primary)] shadow-[var(--inkblot-shadow-md)]","transition-[opacity,transform] duration-[var(--inkblot-duration-normal)] ease-[var(--inkblot-easing-default)]","origin-top",h?"pointer-events-auto scale-y-100 opacity-100":"pointer-events-none scale-y-95 opacity-0"),children:[jsxRuntimeExports.jsx("div",{className:"border-b border-[var(--inkblot-semantic-color-border-default)] p-[var(--inkblot-spacing-2)]",children:jsxRuntimeExports.jsxs("div",{className:"flex items-center gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-sm)] bg-[var(--inkblot-semantic-color-background-tertiary)] px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-1)]",children:[jsxRuntimeExports.jsx(Search,{className:"size-3.5 shrink-0 text-[var(--inkblot-semantic-color-text-tertiary)]"}),jsxRuntimeExports.jsx("input",{ref:W,type:"text",value:P,onChange:T=>{N(T.target.value),k(-1);},placeholder:s,className:"w-full bg-transparent py-[var(--inkblot-spacing-1)] text-sm text-[var(--inkblot-semantic-color-text-primary)] placeholder:text-[var(--inkblot-semantic-color-text-tertiary)] focus:outline-none"})]})}),jsxRuntimeExports.jsx("ul",{ref:L,role:"listbox",className:"max-h-60 overflow-y-auto p-[var(--inkblot-spacing-1)]",children:C?jsxRuntimeExports.jsxs("li",{className:"flex items-center justify-center gap-[var(--inkblot-spacing-2)] px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-4)] text-sm text-[var(--inkblot-semantic-color-text-tertiary)]",children:[jsxRuntimeExports.jsx(LoaderCircle,{className:"size-4 animate-spin","aria-hidden":true}),c]}):$.length===0?jsxRuntimeExports.jsx("li",{className:"px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-4)] text-center text-sm text-[var(--inkblot-semantic-color-text-tertiary)]",children:l}):$.map((T,q)=>{let U=T.value===w,ze=q===y;return jsxRuntimeExports.jsxs("li",{role:"option","data-option":true,"aria-selected":U,"aria-disabled":T.disabled,onClick:()=>{T.disabled||Yt(T.value);},onMouseEnter:()=>{T.disabled||k(q);},className:o("flex cursor-pointer items-center gap-[var(--inkblot-spacing-3)] rounded-[var(--inkblot-radius-sm)] px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-2)]","transition-colors duration-[var(--inkblot-duration-fast)]",ze&&!T.disabled&&"bg-[var(--inkblot-semantic-color-interactive-secondary-hover)]",U&&"bg-[var(--inkblot-semantic-color-interactive-secondary)]",T.disabled&&"pointer-events-none cursor-not-allowed opacity-[var(--inkblot-opacity-disabled)]"),children:[T.icon&&jsxRuntimeExports.jsx("span",{className:"flex size-5 shrink-0 items-center justify-center text-[var(--inkblot-semantic-color-text-secondary)]",children:T.icon}),jsxRuntimeExports.jsxs("span",{className:"flex min-w-0 flex-1 flex-col",children:[jsxRuntimeExports.jsx("span",{className:"truncate text-sm text-[var(--inkblot-semantic-color-text-primary)]",children:T.label}),T.description&&jsxRuntimeExports.jsx("span",{className:"truncate text-xs text-[var(--inkblot-semantic-color-text-tertiary)]",children:T.description})]})]},T.value)})})]})]})}var Zc={info:"border-[var(--inkblot-semantic-color-status-info)] bg-[var(--inkblot-semantic-color-status-info)]/10 text-[var(--inkblot-semantic-color-text-primary)]",success:"border-[var(--inkblot-semantic-color-status-success)] bg-[var(--inkblot-semantic-color-status-success)]/10 text-[var(--inkblot-semantic-color-text-primary)]",warning:"border-[var(--inkblot-semantic-color-status-warning)] bg-[var(--inkblot-semantic-color-status-warning)]/10 text-[var(--inkblot-semantic-color-text-primary)]",error:"border-[var(--inkblot-semantic-color-status-error)] bg-[var(--inkblot-semantic-color-status-error)]/10 text-[var(--inkblot-semantic-color-text-primary)]"},Qc={info:Info,success:CircleCheck,warning:TriangleAlert,error:CircleAlert};function Jc({title:t,description:e,variant:r="info",className:a}){let i=Qc[r];return jsxRuntimeExports.jsxs("div",{role:"alert",className:o("flex w-full items-start gap-[var(--inkblot-spacing-3)] rounded-[var(--inkblot-radius-lg)] border px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-3)]",Zc[r],a),children:[jsxRuntimeExports.jsx(i,{className:"mt-0.5 h-4 w-4 shrink-0"}),jsxRuntimeExports.jsxs("div",{className:"flex min-w-0 flex-col gap-[var(--inkblot-spacing-1)]",children:[jsxRuntimeExports.jsx("div",{className:"font-semibold",children:t}),e&&jsxRuntimeExports.jsx("div",{className:"text-sm text-[var(--inkblot-semantic-color-text-secondary)]",children:e})]})]})}const {useCallback:_a,useEffect:td,useId:Ua,useRef:ao} = await importShared('react');
function rd({open:t,title:e,description:r,confirmLabel:a="Confirm",cancelLabel:i="Cancel",destructive:n=false,confirmDisabled:s=false,closeOnConfirm:l=true,initialFocusRef:c,onOpenChange:d,onConfirm:m,onCancel:p,className:b}){let u=ao(null),f=ao(null),w=ao(null),h=Ua(),g=Ua(),P=_a(()=>{p?.(),d?.(false);},[p,d]),N=_a(()=>{m?.(),l&&d?.(false);},[l,m,d]);return td(()=>{if(!t)return;w.current=document.activeElement instanceof HTMLElement?document.activeElement:null,(c?.current??f.current??u.current)?.focus();let k=v=>{v.key==="Escape"&&P();};return window.addEventListener("keydown",k),()=>{window.removeEventListener("keydown",k),w.current?.focus();}},[P,c,t]),t?jsxRuntimeExports.jsx("div",{className:"fixed inset-0 z-50 grid place-items-center bg-[var(--inkblot-semantic-color-background-primary)]/70 px-[var(--inkblot-spacing-4)]",onClick:P,children:jsxRuntimeExports.jsxs("div",{role:"alertdialog","aria-modal":"true","aria-labelledby":h,"aria-describedby":r?g:void 0,tabIndex:-1,ref:u,onClick:y=>y.stopPropagation(),className:o("w-full max-w-[520px] rounded-[var(--inkblot-radius-xl)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] p-[var(--inkblot-spacing-6)] text-[var(--inkblot-semantic-color-text-primary)] shadow-lg",b),children:[jsxRuntimeExports.jsxs("div",{className:"mb-[var(--inkblot-spacing-4)] flex items-start gap-[var(--inkblot-spacing-3)]",children:[jsxRuntimeExports.jsx("div",{className:o("mt-0.5 rounded-[var(--inkblot-radius-full)] p-[var(--inkblot-spacing-2)]",n?"bg-[var(--inkblot-semantic-color-status-error)]/15 text-[var(--inkblot-semantic-color-status-error)]":"bg-[var(--inkblot-semantic-color-status-warning)]/15 text-[var(--inkblot-semantic-color-status-warning)]"),children:jsxRuntimeExports.jsx(TriangleAlert,{className:"h-5 w-5"})}),jsxRuntimeExports.jsxs("div",{className:"flex-1",children:[jsxRuntimeExports.jsx("h2",{id:h,className:"text-lg font-semibold",children:e}),r&&jsxRuntimeExports.jsx("p",{id:g,className:"mt-[var(--inkblot-spacing-2)] text-sm text-[var(--inkblot-semantic-color-text-secondary)]",children:r})]})]}),jsxRuntimeExports.jsxs("div",{className:"flex flex-wrap justify-end gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("button",{type:"button",ref:f,onClick:P,className:"inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-interactive-secondary)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)] font-medium text-[var(--inkblot-semantic-color-text-primary)] transition-colors duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] active:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)]",children:i}),jsxRuntimeExports.jsx("button",{type:"button",disabled:s,onClick:N,className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center rounded-[var(--inkblot-radius-md)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)] font-medium text-[var(--inkblot-semantic-color-text-inverse)] transition-colors duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)] disabled:cursor-not-allowed disabled:opacity-[var(--inkblot-opacity-disabled)]",n?"bg-[var(--inkblot-semantic-color-status-error)] hover:bg-[var(--inkblot-semantic-color-status-error)]/85 active:bg-[var(--inkblot-semantic-color-status-error)]/80":"bg-[var(--inkblot-semantic-color-interactive-primary)] hover:bg-[var(--inkblot-semantic-color-interactive-primary-hover)] active:bg-[var(--inkblot-semantic-color-interactive-primary-active)]"),children:a})]})]})}):null}const {useEffect:od,useRef:ad,useState:no} = await importShared('react');
var sd=["Write a product launch announcement for a SaaS tool","Create a re-engagement email for churned users","Draft a welcome email for new customers","Write a quarterly business review summary","Create a seasonal promotion email with urgency"];function qh({value:t,defaultValue:e="",onValueChange:r,isGenerating:a,onGeneratingChange:i,generated:n,onGeneratedChange:s,generationDelayMs:l=1500,onSubmitPrompt:c,generateBlocks:d,onGenerate:m,suggestions:p=sd,className:b}){let[u,f]=no(e),[w,h]=no(false),[g,P]=no(false),N=ad(null),y=t!==void 0,k=y?t:u,v=a!==void 0,x=v?a:w,C=n!==void 0,S=C?n:g,D=L=>{y||f(L),r?.(L);},E=L=>{v||h(L),i?.(L);},F=L=>{C||P(L),s?.(L);};od(()=>()=>{N.current!==null&&window.clearTimeout(N.current);},[]);let I=L=>{let W=Date.now();return [{id:`ai-${W}-1`,type:"heading",content:"Exciting News from Our Team"},{id:`ai-${W}-2`,type:"text",content:`Generated from prompt: ${L}`},{id:`ai-${W}-3`,type:"image",content:""},{id:`ai-${W}-4`,type:"text",content:"Our latest updates are designed to help you achieve more with less effort. We've built these improvements with your feedback in mind."},{id:`ai-${W}-5`,type:"button",content:"Learn More"},{id:`ai-${W}-6`,type:"divider",content:""},{id:`ai-${W}-7`,type:"text",content:`Best regards,
The Team`}]},O=async()=>{let L=k.trim();if(!L||x)return;c?.(L),E(true);let W;d?W=await Promise.resolve(d(L)):(await new Promise($=>{window.setTimeout(()=>$(),l);}),W=I(L)),m?.(W),E(false),F(true),N.current=window.setTimeout(()=>F(false),1800);};return jsxRuntimeExports.jsxs("section",{className:o(b),children:[jsxRuntimeExports.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[jsxRuntimeExports.jsx(Sparkles,{className:"h-4 w-4 text-[var(--inkblot-semantic-color-status-warning)]"}),jsxRuntimeExports.jsx("span",{className:"text-xs font-medium text-[var(--inkblot-semantic-color-text-primary)]",children:"AI Email Generator"})]}),jsxRuntimeExports.jsxs("div",{className:"space-y-3",children:[jsxRuntimeExports.jsx("textarea",{value:k,onChange:L=>D(L.target.value),rows:3,placeholder:"Describe the email you want to create...",className:"w-full resize-none rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] px-4 py-3 text-sm text-[var(--inkblot-semantic-color-text-primary)] placeholder:text-[var(--inkblot-semantic-color-text-tertiary)] outline-none"}),jsxRuntimeExports.jsx("div",{className:"flex flex-wrap gap-1.5",children:p.map(L=>jsxRuntimeExports.jsx("button",{type:"button",onClick:()=>D(L),className:"rounded-[var(--inkblot-radius-sm)] bg-[var(--inkblot-semantic-color-interactive-secondary)] px-2.5 py-1 text-[10px] text-[var(--inkblot-semantic-color-text-primary)] transition-opacity duration-[var(--inkblot-duration-fast)] hover:opacity-85",children:L},L))}),jsxRuntimeExports.jsx("button",{type:"button",onClick:O,disabled:!k.trim()||x,className:"flex items-center gap-2 rounded-[var(--inkblot-radius-md)] bg-[var(--inkblot-semantic-color-status-warning)]/10 px-4 py-2 text-xs font-medium text-[var(--inkblot-semantic-color-status-warning)] transition-opacity duration-[var(--inkblot-duration-fast)] disabled:opacity-40",children:x?jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:[jsxRuntimeExports.jsx(LoaderCircle,{className:"h-3 w-3 animate-spin"}),"Generating..."]}):S?jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:[jsxRuntimeExports.jsx(Check,{className:"h-3 w-3"}),"Applied to editor"]}):jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:[jsxRuntimeExports.jsx(Sparkles,{className:"h-3 w-3"}),"Generate Email"]})})]})]})}function lo({label:t,icon:e,active:r=false,onClick:a,title:i,dataTour:n,className:s}){return jsxRuntimeExports.jsxs("button",{type:"button",onClick:a,"data-tour":n,className:o("group relative flex h-10 w-10 shrink-0 items-center justify-center rounded-[var(--inkblot-radius-md)] border border-transparent transition-colors duration-[var(--inkblot-duration-fast)]",r?"bg-[var(--inkblot-semantic-color-interactive-secondary)] text-[var(--inkblot-semantic-color-text-primary)]":"text-[var(--inkblot-semantic-color-text-tertiary)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] hover:text-[var(--inkblot-semantic-color-text-primary)]",s),title:i??t,"aria-current":r?"page":void 0,"aria-label":t,children:[jsxRuntimeExports.jsx(e,{className:"h-[18px] w-[18px]","aria-hidden":true}),r?jsxRuntimeExports.jsx("span",{className:"absolute left-0 top-1/2 h-4 w-[2px] -translate-y-1/2 rounded-r bg-[var(--inkblot-semantic-color-interactive-primary)]"}):null,jsxRuntimeExports.jsx("span",{className:"pointer-events-none absolute left-full z-50 ml-3 whitespace-nowrap rounded-[var(--inkblot-radius-sm)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] px-2 py-1 text-xs font-medium text-[var(--inkblot-semantic-color-text-primary)] opacity-0 transition-opacity duration-[var(--inkblot-duration-fast)] group-hover:opacity-100",children:t})]})}var fd=[{id:"canvas",icon:MessageSquare,label:"Canvas",path:"/",dataTour:"nav-canvas"},{id:"invoices",icon:FileText,label:"Invoices & Deals",path:"/invoices",dataTour:"nav-invoices"},{id:"contacts",icon:Users,label:"Contacts",path:"/contacts",dataTour:"nav-contacts"},{id:"campaigns",icon:Mail,label:"Campaigns",path:"/campaigns",dataTour:"nav-campaigns"},{id:"tasks",icon:SquareCheckBig,label:"Tasks",path:"/tasks",dataTour:"nav-tasks"}],gd=[{id:"settings",icon:Settings,label:"Settings",path:"/settings",dataTour:"nav-settings"}];function ja({items:t=fd,bottomItems:e=gd,activePath:r="/",onNavigate:a,logo:i,showStatusDot:n=true,showThemeToggle:s=true,className:l}){return jsxRuntimeExports.jsxs("aside",{"data-tour":"sidebar",className:o("flex h-full w-16 flex-col items-center gap-1 border-r border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] py-4",l),children:[jsxRuntimeExports.jsx("div",{className:"mb-6 flex h-9 w-9 items-center justify-center rounded-[var(--inkblot-radius-md)] bg-[var(--inkblot-semantic-color-interactive-primary)]",children:i??jsxRuntimeExports.jsx(Command,{className:"h-4 w-4 text-[var(--inkblot-semantic-color-text-inverse)]","aria-hidden":true})}),jsxRuntimeExports.jsx("nav",{className:"hide-scrollbar flex flex-1 flex-col gap-1 overflow-y-auto",children:t.map(c=>jsxRuntimeExports.jsx(lo,{label:c.label,icon:c.icon,active:c.path===r,onClick:()=>a?.(c.path),dataTour:c.dataTour},c.id))}),jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-1",children:[e.map(c=>jsxRuntimeExports.jsx(lo,{label:c.label,icon:c.icon,active:c.path===r,onClick:()=>a?.(c.path),dataTour:c.dataTour},c.id)),s?jsxRuntimeExports.jsxs("div",{className:"group relative flex justify-center",children:[jsxRuntimeExports.jsx(vr,{}),jsxRuntimeExports.jsx("span",{className:"pointer-events-none absolute left-full z-50 ml-3 whitespace-nowrap rounded-[var(--inkblot-radius-sm)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] px-2 py-1 text-xs font-medium text-[var(--inkblot-semantic-color-text-primary)] opacity-0 transition-opacity duration-[var(--inkblot-duration-fast)] group-hover:opacity-100",children:"Theme"})]}):null,n?jsxRuntimeExports.jsx("span",{"data-tour":"system-status",className:"mx-auto mt-2 h-2 w-2 animate-pulse rounded-full bg-[var(--inkblot-semantic-color-status-success)]",title:"System Online"}):null]})]})}var wd=[{id:1,icon:Mail,title:"Email opened",meta:"Jane Smith \xB7 Acme Corp",time:"2m ago",status:"info"},{id:2,icon:CreditCard,title:"Invoice #1042 paid",meta:"$24,500 \xB7 TechVentures",time:"8m ago",status:"success"},{id:3,icon:Zap,title:"Pipeline stage changed",meta:"Negotiation \u2192 Closing",time:"14m ago",status:"warning"},{id:4,icon:Phone,title:"Call completed",meta:"12 min \xB7 Mark Johnson",time:"23m ago",status:"info"},{id:5,icon:FileText,title:"Contract signed",meta:"NDA \xB7 GlobalTech Inc",time:"1h ago",status:"success"},{id:6,icon:GitBranch,title:"New relationship detected",meta:"Acme \u2194 DataFlow Labs",time:"2h ago",status:"info"},{id:7,icon:CreditCard,title:"Invoice overdue",meta:"$8,200 \xB7 StartupXYZ",time:"3h ago",status:"danger"}],Cd={success:"bg-[var(--inkblot-semantic-color-status-success)]",warning:"bg-[var(--inkblot-semantic-color-status-warning)]",error:"bg-[var(--inkblot-semantic-color-status-error)]",danger:"bg-[var(--inkblot-semantic-color-status-error)]",info:"bg-[var(--inkblot-semantic-color-status-info)]"};function Ya({title:t="Event Stream",liveLabel:e="Live",events:r=wd,onItemClick:a,className:i}){return jsxRuntimeExports.jsxs("section",{className:o("p-4",i),children:[jsxRuntimeExports.jsxs("header",{className:"mb-4 flex items-center justify-between",children:[jsxRuntimeExports.jsx("h3",{className:"text-xs font-medium uppercase tracking-wide text-[var(--inkblot-semantic-color-text-tertiary)]",children:t}),jsxRuntimeExports.jsx("span",{className:"text-[10px] font-medium text-[var(--inkblot-semantic-color-text-tertiary)]",children:e})]}),jsxRuntimeExports.jsx("ul",{className:"space-y-1",children:r.map(n=>{let s=n.icon;return jsxRuntimeExports.jsx("li",{children:jsxRuntimeExports.jsxs("button",{type:"button",onClick:()=>a?.(n),className:"group flex w-full items-start gap-3 rounded-[var(--inkblot-radius-md)] px-2.5 py-2.5 text-left transition-colors duration-[var(--inkblot-duration-fast)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)]",children:[jsxRuntimeExports.jsx("span",{className:"mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-[var(--inkblot-radius-sm)] bg-[var(--inkblot-semantic-color-background-tertiary)]",children:jsxRuntimeExports.jsx(s,{className:"h-3.5 w-3.5 text-[var(--inkblot-semantic-color-text-tertiary)] group-hover:text-[var(--inkblot-semantic-color-text-secondary)]","aria-hidden":true})}),jsxRuntimeExports.jsxs("span",{className:"min-w-0 flex-1",children:[jsxRuntimeExports.jsxs("span",{className:"flex items-center gap-2",children:[jsxRuntimeExports.jsx("span",{className:o("h-1.5 w-1.5 shrink-0 rounded-full",Cd[n.status])}),jsxRuntimeExports.jsx("span",{className:"truncate text-xs font-medium text-[var(--inkblot-semantic-color-text-primary)]",children:n.title})]}),jsxRuntimeExports.jsx("span",{className:"mt-0.5 block truncate text-[10px] text-[var(--inkblot-semantic-color-text-tertiary)]",children:n.meta})]}),jsxRuntimeExports.jsx("span",{className:"mt-0.5 shrink-0 text-[10px] text-[var(--inkblot-semantic-color-text-tertiary)]",children:n.time})]})},n.id)})})]})}const {createContext:Td,useContext:Pd,useState:Sd,useCallback:Xa} = await importShared('react');
var Za=Td(null);function Md(){let t=Pd(Za);if(!t)throw new Error("useCanvas must be used within a CanvasProvider");return t}var Ed=[{id:"welcome-1",type:"text",content:"Welcome to Citron OS. Use the AI chat on the right to interact with your revenue engine."},{id:"welcome-2",type:"entity"},{id:"welcome-3",type:"intelligence"}];function mo({children:t,initialBlocks:e=Ed}){let[r,a]=Sd(e),i=Xa(s=>{a(l=>[...l,...s]);},[]),n=Xa(()=>{a([]);},[]);return jsxRuntimeExports.jsx(Za.Provider,{value:{blocks:r,addBlocks:i,clearBlocks:n},children:t})}function SN({children:t,showEventFeed:e=false,sidebarProps:r,eventFeedProps:a,canvasProviderProps:i,className:n}){let s=jsxRuntimeExports.jsxs("div",{className:o("flex h-screen w-full overflow-hidden bg-[var(--inkblot-semantic-color-background-primary)]",n),children:[jsxRuntimeExports.jsx(ja,{...r}),jsxRuntimeExports.jsxs("main",{className:"flex flex-1 overflow-hidden",children:[jsxRuntimeExports.jsx("section",{"data-tour":"canvas",className:"hide-scrollbar flex-1 overflow-y-auto",children:t}),e&&jsxRuntimeExports.jsx("aside",{"data-tour":"event-feed",className:"flex w-80 flex-col overflow-hidden border-l border-[var(--inkblot-semantic-color-border-default)]",children:jsxRuntimeExports.jsx(Ya,{...a})})]})]});return i?jsxRuntimeExports.jsx(mo,{...i,children:s}):s}function Ld({ratio:t=16/9,children:e,className:r}){let a=Number.isFinite(t)&&t>0?t:1.7777777777777777;return jsxRuntimeExports.jsxs("div",{className:o("relative w-full overflow-hidden",r),children:[jsxRuntimeExports.jsx("div",{style:{paddingTop:`${1/a*100}%`}}),jsxRuntimeExports.jsx("div",{className:"absolute inset-0",children:e})]})}var Dd={default:"bg-[var(--inkblot-semantic-color-interactive-primary)] text-[var(--inkblot-semantic-color-text-inverse)]",secondary:"bg-[var(--inkblot-semantic-color-background-tertiary)] text-[var(--inkblot-semantic-color-text-primary)]",success:"bg-[var(--inkblot-semantic-color-status-success)]/15 text-[var(--inkblot-semantic-color-status-success)]",warning:"bg-[var(--inkblot-semantic-color-status-warning)]/15 text-[var(--inkblot-semantic-color-status-warning)]",error:"bg-[var(--inkblot-semantic-color-status-error)]/15 text-[var(--inkblot-semantic-color-status-error)]",outline:"border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] text-[var(--inkblot-semantic-color-text-primary)]"};function Rd({children:t,variant:e="default",disabled:r=false,className:a}){return jsxRuntimeExports.jsx("span",{"aria-disabled":r,className:o("inline-flex min-h-[calc(var(--inkblot-size-touch-target-min)-1rem)] items-center justify-center rounded-[var(--inkblot-radius-full)] px-[var(--inkblot-spacing-2)] py-[var(--inkblot-spacing-1)] text-xs font-semibold transition-colors duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)]",Dd[e],r&&"opacity-[var(--inkblot-opacity-disabled)]",a),children:t})}function Od({items:t,className:e}){return jsxRuntimeExports.jsx("nav",{"aria-label":"Breadcrumb",className:o("w-full",e),children:jsxRuntimeExports.jsx("ol",{className:"flex flex-wrap items-center gap-[var(--inkblot-spacing-2)]",children:t.map((r,a)=>{let i=r.href&&!r.disabled&&!r.current?jsxRuntimeExports.jsx("a",{href:r.href,onClick:r.onClick,className:"rounded-[var(--inkblot-radius-sm)] text-sm text-[var(--inkblot-semantic-color-text-secondary)] transition-colors duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)] hover:text-[var(--inkblot-semantic-color-text-primary)]",children:r.label}):jsxRuntimeExports.jsx("span",{"aria-current":r.current?"page":void 0,className:o("text-sm",r.current?"font-semibold text-[var(--inkblot-semantic-color-text-primary)]":"text-[var(--inkblot-semantic-color-text-tertiary)]",r.disabled&&"opacity-[var(--inkblot-opacity-disabled)]"),children:r.label});return jsxRuntimeExports.jsxs("li",{className:"flex items-center gap-[var(--inkblot-spacing-2)]",children:[i,a<t.length-1&&jsxRuntimeExports.jsx(ChevronRight,{className:"h-4 w-4 text-[var(--inkblot-semantic-color-text-tertiary)]"})]},r.id)})})})}const {useMemo:tn,useState:Fd} = await importShared('react');
var Kd=["L","M","X","J","V","S","D"];function en(t){return new Date(t.getFullYear(),t.getMonth(),1)}function Wd(t){return new Date(t.getFullYear(),t.getMonth()+1,0)}function _d(t,e){return t.getFullYear()===e.getFullYear()&&t.getMonth()===e.getMonth()&&t.getDate()===e.getDate()}function po(t){return `${t.getFullYear()}-${t.getMonth()}-${t.getDate()}`}function Ud(t){let e=en(t),r=Wd(t),a=(e.getDay()+6)%7,i=r.getDate(),n=[];for(let s=0;s<a;s+=1)n.push(null);for(let s=1;s<=i;s+=1)n.push(new Date(t.getFullYear(),t.getMonth(),s));for(;n.length%7!==0;)n.push(null);return n}function $d({value:t,onChange:e,disabledDates:r,className:a}){let i=t??new Date,[n,s]=Fd(en(i)),l=tn(()=>Ud(n),[n]),c=tn(()=>new Set((r??[]).map(po)),[r]);return jsxRuntimeExports.jsxs("div",{className:o("w-[320px] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] p-[var(--inkblot-spacing-4)] text-[var(--inkblot-semantic-color-text-primary)]",a),children:[jsxRuntimeExports.jsxs("div",{className:"mb-[var(--inkblot-spacing-3)] flex items-center justify-between",children:[jsxRuntimeExports.jsx("button",{type:"button",onClick:()=>s(new Date(n.getFullYear(),n.getMonth()-1,1)),className:"inline-flex h-8 w-8 items-center justify-center rounded-[var(--inkblot-radius-md)] text-[var(--inkblot-semantic-color-text-secondary)] hover:bg-[var(--inkblot-semantic-color-background-tertiary)]",children:jsxRuntimeExports.jsx(ChevronLeft,{className:"h-4 w-4"})}),jsxRuntimeExports.jsx("div",{className:"font-semibold",children:n.toLocaleDateString("es-ES",{month:"long",year:"numeric"})}),jsxRuntimeExports.jsx("button",{type:"button",onClick:()=>s(new Date(n.getFullYear(),n.getMonth()+1,1)),className:"inline-flex h-8 w-8 items-center justify-center rounded-[var(--inkblot-radius-md)] text-[var(--inkblot-semantic-color-text-secondary)] hover:bg-[var(--inkblot-semantic-color-background-tertiary)]",children:jsxRuntimeExports.jsx(ChevronRight,{className:"h-4 w-4"})})]}),jsxRuntimeExports.jsxs("div",{className:"grid grid-cols-7 gap-[var(--inkblot-spacing-1)]",children:[Kd.map(d=>jsxRuntimeExports.jsx("div",{className:"pb-[var(--inkblot-spacing-1)] text-center text-xs font-medium text-[var(--inkblot-semantic-color-text-tertiary)]",children:d},d)),l.map((d,m)=>{if(!d)return jsxRuntimeExports.jsx("div",{className:"h-9"},`empty-${m}`);let p=c.has(po(d)),b=t?_d(d,t):false;return jsxRuntimeExports.jsx("button",{type:"button",disabled:p,onClick:()=>e?.(d),className:o("h-9 rounded-[var(--inkblot-radius-md)] text-sm transition-colors duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)]",b?"bg-[var(--inkblot-semantic-color-interactive-primary)] text-[var(--inkblot-semantic-color-text-inverse)]":"text-[var(--inkblot-semantic-color-text-primary)] hover:bg-[var(--inkblot-semantic-color-background-tertiary)]",p&&"cursor-not-allowed opacity-[var(--inkblot-opacity-disabled)]"),children:d.getDate()},po(d))})]})]})}function jd({className:t,interactive:e=false,disabled:r=false,...a}){return jsxRuntimeExports.jsx("div",{"aria-disabled":r,className:o("w-full rounded-[var(--inkblot-radius-xl)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] text-[var(--inkblot-semantic-color-text-primary)]",e&&"transition-[border-color,transform,background] duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)] hover:border-[var(--inkblot-semantic-color-border-strong)] hover:bg-[var(--inkblot-semantic-color-background-tertiary)] active:translate-y-px",r&&"pointer-events-none opacity-[var(--inkblot-opacity-disabled)]",t),...a})}function qd({className:t,...e}){return jsxRuntimeExports.jsx("div",{className:o("flex flex-col gap-[var(--inkblot-spacing-1)] p-[var(--inkblot-spacing-5)]",t),...e})}function Yd({className:t,...e}){return jsxRuntimeExports.jsx("h3",{className:o("text-base font-semibold text-[var(--inkblot-semantic-color-text-primary)]",t),...e})}function Xd({className:t,...e}){return jsxRuntimeExports.jsx("p",{className:o("text-sm text-[var(--inkblot-semantic-color-text-secondary)]",t),...e})}function Zd({className:t,...e}){return jsxRuntimeExports.jsx("div",{className:o("px-[var(--inkblot-spacing-5)] pb-[var(--inkblot-spacing-5)]",t),...e})}function Qd({className:t,...e}){return jsxRuntimeExports.jsx("div",{className:o("flex items-center justify-end gap-[var(--inkblot-spacing-2)] border-t border-[var(--inkblot-semantic-color-border-default)] px-[var(--inkblot-spacing-5)] py-[var(--inkblot-spacing-4)]",t),...e})}const {useState:Jd} = await importShared('react');
function rm({items:t,initialIndex:e=0,loop:r=false,className:a}){let[i,n]=Jd(Math.min(Math.max(e,0),Math.max(t.length-1,0))),s=r||i>0,l=r||i<t.length-1,c=()=>{if(t.length!==0){if(r){n(m=>(m-1+t.length)%t.length);return}n(m=>Math.max(m-1,0));}},d=()=>{if(t.length!==0){if(r){n(m=>(m+1)%t.length);return}n(m=>Math.min(m+1,t.length-1));}};return jsxRuntimeExports.jsxs("div",{className:o("w-full rounded-[var(--inkblot-radius-xl)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] p-[var(--inkblot-spacing-4)]",a),children:[jsxRuntimeExports.jsx("div",{className:"relative overflow-hidden rounded-[var(--inkblot-radius-lg)]",children:jsxRuntimeExports.jsx("div",{className:"flex transition-transform duration-[var(--inkblot-duration-normal)] ease-[var(--inkblot-easing-default)]",style:{transform:`translateX(-${i*100}%)`},children:t.map((m,p)=>jsxRuntimeExports.jsx("div",{className:"w-full shrink-0",children:m},p))})}),jsxRuntimeExports.jsxs("div",{className:"mt-[var(--inkblot-spacing-3)] flex items-center justify-between",children:[jsxRuntimeExports.jsx("div",{className:"text-sm text-[var(--inkblot-semantic-color-text-secondary)]",children:t.length>0?`${i+1} de ${t.length}`:"Sin elementos"}),jsxRuntimeExports.jsxs("div",{className:"flex gap-[var(--inkblot-spacing-2)]",children:[jsxRuntimeExports.jsx("button",{type:"button",onClick:c,disabled:!s||t.length===0,className:"inline-flex h-9 w-9 items-center justify-center rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-interactive-secondary)] text-[var(--inkblot-semantic-color-text-primary)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] disabled:cursor-not-allowed disabled:opacity-[var(--inkblot-opacity-disabled)]",children:jsxRuntimeExports.jsx(ChevronLeft,{className:"h-4 w-4"})}),jsxRuntimeExports.jsx("button",{type:"button",onClick:d,disabled:!l||t.length===0,className:"inline-flex h-9 w-9 items-center justify-center rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-interactive-secondary)] text-[var(--inkblot-semantic-color-text-primary)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] disabled:cursor-not-allowed disabled:opacity-[var(--inkblot-opacity-disabled)]",children:jsxRuntimeExports.jsx(ChevronRight,{className:"h-4 w-4"})})]})]})]})}function om({data:t,title:e="Rendimiento",emptyMessage:r="No data to display.",className:a}){let i=Math.max(...t.map(n=>n.value),0);return jsxRuntimeExports.jsxs("div",{className:o("w-full rounded-[var(--inkblot-radius-xl)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] p-[var(--inkblot-spacing-5)]",a),children:[jsxRuntimeExports.jsx("h3",{className:"mb-[var(--inkblot-spacing-4)] text-sm font-semibold text-[var(--inkblot-semantic-color-text-primary)]",children:e}),t.length===0?jsxRuntimeExports.jsx("div",{className:"rounded-[var(--inkblot-radius-md)] bg-[var(--inkblot-semantic-color-background-tertiary)] px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-4)] text-sm text-[var(--inkblot-semantic-color-text-secondary)]",children:r}):jsxRuntimeExports.jsx("div",{className:"flex flex-col gap-[var(--inkblot-spacing-3)]",children:t.map(n=>{let s=i>0?n.value/i*100:0;return jsxRuntimeExports.jsxs("div",{className:"grid grid-cols-[120px_1fr_48px] items-center gap-[var(--inkblot-spacing-3)]",children:[jsxRuntimeExports.jsx("span",{className:"truncate text-sm text-[var(--inkblot-semantic-color-text-secondary)]",children:n.label}),jsxRuntimeExports.jsx("div",{className:"h-3 overflow-hidden rounded-[var(--inkblot-radius-full)] bg-[var(--inkblot-semantic-color-background-tertiary)]",children:jsxRuntimeExports.jsx("div",{className:"h-full rounded-[var(--inkblot-radius-full)] bg-[var(--inkblot-semantic-color-interactive-primary)]",style:{width:`${s}%`,backgroundColor:n.color??"var(--inkblot-semantic-color-interactive-primary)"}})}),jsxRuntimeExports.jsx("span",{className:"text-right text-sm font-medium text-[var(--inkblot-semantic-color-text-primary)]",children:n.value})]},n.id)})})]})}const {useState:am} = await importShared('react');
function im({checked:t,defaultChecked:e=false,onCheckedChange:r,label:a,description:i,disabled:n=false,error:s=false,className:l}){let[c,d]=am(e),m=t!==void 0,p=m?t:c,b=u=>{m||d(u),r?.(u);};return jsxRuntimeExports.jsxs("label",{className:o("inline-flex items-start gap-[var(--inkblot-spacing-3)] text-[var(--inkblot-semantic-color-text-primary)]",n&&"cursor-not-allowed opacity-[var(--inkblot-opacity-disabled)]",l),children:[jsxRuntimeExports.jsx("button",{type:"button",role:"checkbox","aria-checked":p,disabled:n,onClick:()=>b(!p),className:o("mt-0.5 inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-[var(--inkblot-radius-sm)] border transition-colors duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--inkblot-semantic-color-border-focus)] focus-visible:outline-offset-2",p?"border-[var(--inkblot-semantic-color-interactive-primary)] bg-[var(--inkblot-semantic-color-interactive-primary)] text-[var(--inkblot-semantic-color-text-inverse)]":"border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] hover:border-[var(--inkblot-semantic-color-border-strong)]",s&&!p&&"border-[var(--inkblot-semantic-color-status-error)]"),children:p&&jsxRuntimeExports.jsx(Check,{className:"h-4 w-4"})}),(a||i)&&jsxRuntimeExports.jsxs("span",{className:"flex flex-col gap-[var(--inkblot-spacing-1)]",children:[a&&jsxRuntimeExports.jsx("span",{className:"text-sm font-medium",children:a}),i&&jsxRuntimeExports.jsx("span",{className:o("text-xs text-[var(--inkblot-semantic-color-text-secondary)]",s&&!p&&"text-[var(--inkblot-semantic-color-status-error)]"),children:i})]})]})}var sm={success:"var(--inkblot-semantic-color-status-success)",warning:"var(--inkblot-semantic-color-status-warning)",error:"var(--inkblot-semantic-color-status-error)",info:"var(--inkblot-semantic-color-status-info)",primary:"var(--inkblot-semantic-color-interactive-primary)"};function an({label:t,value:e,tone:r="primary",color:a,inverted:i=false,size:n=72,className:s}){let l=Math.max(0,Math.min(100,e)),c=i?100-l:l,d=5,m=(n-d)/2,p=2*Math.PI*m,b=p-c/100*p,u=a??sm[r];return jsxRuntimeExports.jsx("div",{className:s,children:jsxRuntimeExports.jsxs("div",{className:"flex flex-col items-center gap-2",children:[jsxRuntimeExports.jsxs("div",{className:"relative",style:{width:n,height:n},children:[jsxRuntimeExports.jsxs("svg",{width:n,height:n,className:"-rotate-90",children:[jsxRuntimeExports.jsx("circle",{cx:n/2,cy:n/2,r:m,fill:"none",stroke:"var(--inkblot-semantic-color-background-tertiary)",strokeWidth:d}),jsxRuntimeExports.jsx("circle",{cx:n/2,cy:n/2,r:m,fill:"none",stroke:u,strokeWidth:d,strokeDasharray:p,strokeDashoffset:b,strokeLinecap:"round",className:"transition-[stroke-dashoffset] duration-[var(--inkblot-duration-fast)]"})]}),jsxRuntimeExports.jsx("span",{className:"absolute inset-0 flex items-center justify-center text-sm font-semibold text-[var(--inkblot-semantic-color-text-primary)]",children:l})]}),jsxRuntimeExports.jsx("span",{className:"text-center text-[10px] leading-tight text-[var(--inkblot-semantic-color-text-tertiary)]",children:t})]})})}const {useState:lm} = await importShared('react');
function dm({title:t,children:e,defaultOpen:r=false,disabled:a=false,className:i}){let[n,s]=lm(r);return jsxRuntimeExports.jsxs("div",{className:o("w-full rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)]",a&&"opacity-[var(--inkblot-opacity-disabled)]",i),children:[jsxRuntimeExports.jsxs("button",{type:"button",disabled:a,"aria-expanded":n,onClick:()=>s(l=>!l),className:o("flex min-h-[var(--inkblot-size-touch-target-min)] w-full items-center justify-between gap-[var(--inkblot-spacing-3)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-3)] text-left text-[var(--inkblot-semantic-color-text-primary)]",!a&&"hover:bg-[var(--inkblot-semantic-color-background-tertiary)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--inkblot-semantic-color-border-focus)] focus-visible:outline-offset-[-2px]"),children:[jsxRuntimeExports.jsx("span",{className:"font-medium",children:t}),jsxRuntimeExports.jsx(ChevronDown,{className:o("h-4 w-4 text-[var(--inkblot-semantic-color-text-tertiary)] transition-transform duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)]",n&&"rotate-180")})]}),n&&jsxRuntimeExports.jsx("div",{className:"border-t border-[var(--inkblot-semantic-color-border-default)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-4)] text-sm text-[var(--inkblot-semantic-color-text-secondary)]",children:e})]})}const {useMemo:mm,useState:pm} = await importShared('react');
function um({items:t,placeholder:e="Search commands...",onSelect:r,className:a}){let[i,n]=pm(""),s=mm(()=>{let l=i.trim().toLowerCase();return l?t.filter(c=>{let d=c.label.toLowerCase().includes(l),m=(c.keywords??[]).some(p=>p.toLowerCase().includes(l));return d||m}):t},[t,i]);return jsxRuntimeExports.jsxs("div",{className:o("w-full rounded-[var(--inkblot-radius-xl)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)]",a),children:[jsxRuntimeExports.jsxs("div",{className:"flex items-center gap-[var(--inkblot-spacing-2)] border-b border-[var(--inkblot-semantic-color-border-default)] px-[var(--inkblot-spacing-3)]",children:[jsxRuntimeExports.jsx(Search,{className:"h-4 w-4 text-[var(--inkblot-semantic-color-text-tertiary)]"}),jsxRuntimeExports.jsx("input",{value:i,onChange:l=>n(l.target.value),placeholder:e,className:"h-11 w-full bg-transparent text-sm text-[var(--inkblot-semantic-color-text-primary)] outline-none placeholder:text-[var(--inkblot-semantic-color-text-tertiary)]"})]}),jsxRuntimeExports.jsx("div",{className:"max-h-[280px] overflow-y-auto p-[var(--inkblot-spacing-2)]",children:s.length>0?jsxRuntimeExports.jsx("ul",{className:"flex flex-col gap-[var(--inkblot-spacing-1)]",children:s.map(l=>jsxRuntimeExports.jsx("li",{children:jsxRuntimeExports.jsxs("button",{type:"button",disabled:l.disabled,onClick:()=>r?.(l),className:o("flex min-h-[var(--inkblot-size-touch-target-min)] w-full items-center gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-md)] px-[var(--inkblot-spacing-3)] text-left text-sm text-[var(--inkblot-semantic-color-text-primary)] transition-colors duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)]",l.disabled?"cursor-not-allowed opacity-[var(--inkblot-opacity-disabled)]":"hover:bg-[var(--inkblot-semantic-color-background-tertiary)] active:bg-[var(--inkblot-semantic-color-background-tertiary)]"),children:[l.icon&&jsxRuntimeExports.jsx("span",{className:"text-[var(--inkblot-semantic-color-text-tertiary)]",children:l.icon}),jsxRuntimeExports.jsx("span",{children:l.label})]})},l.id))}):jsxRuntimeExports.jsx("div",{className:"px-[var(--inkblot-spacing-2)] py-[var(--inkblot-spacing-3)] text-sm text-[var(--inkblot-semantic-color-text-secondary)]",children:"No results found."})})]})}const {useEffect:vm,useMemo:fm,useRef:gm,useState:ko} = await importShared('react');
var ym=[{id:"1",role:"user",content:"Show me Acme Corp's profile and deal health."},{id:"2",role:"assistant",content:"Here's the entity profile and current intelligence insights for Acme Corp.",cards:["entity","intelligence"]}],yo="rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] p-3 text-xs text-[var(--inkblot-semantic-color-text-tertiary)]";function $w({title:t="Command Canvas",subtitle:e="AI-native interface \u2014 results appear here",readyLabel:r="System ready",placeholder:a="Ask anything \u2014 deals, contacts, forecasts...",footerText:i="Citron OS v1.0 \xB7 AI-native Revenue & Operations Platform",blocks:n,renderBlock:s,messages:l,initialMessages:c=ym,onMessagesChange:d,inputValue:m,defaultInputValue:p="",onInputValueChange:b,autoAssistantResponse:u=true,assistantResponseDelayMs:f=700,isResponding:w,onRespondingChange:h,onSend:g,generateAssistantMessage:P,renderCard:N,hideInput:y=false,className:k}){let[v,x]=ko(c),[C,S]=ko(p),[D,E]=ko(false),F=gm(null),I=l!==void 0,O=I?l:v,L=m!==void 0,W=L?m:C,$=w!==void 0,qt=$?w:D,Yt=W.trim().length>0&&!qt,Er=fm(()=>M=>({content:`Analyzing "${M}". Here are the latest insights.`,cards:["entity","intelligence"]}),[]),T=M=>{I||x(M),d?.(M);},q=M=>{L||S(M),b?.(M);},U=M=>{$||E(M),h?.(M);};vm(()=>()=>{F.current!==null&&window.clearTimeout(F.current);},[]);let ze=()=>{let M=W.trim();if(!M)return;let Xt={id:`${Date.now()}-user`,role:"user",content:M},_o=[...O,Xt];T(_o),q(""),g?.(M),u&&(U(true),F.current=window.setTimeout(()=>{let Uo=(P??Er)(M),Hi=[..._o,{id:`${Date.now()}-assistant`,role:"assistant",content:Uo.content,cards:Uo.cards}];T(Hi),U(false);},f));},Wo=n!==void 0,Ri=M=>M.type==="text"?jsxRuntimeExports.jsxs("div",{className:"flex items-start gap-3",children:[jsxRuntimeExports.jsx("div",{className:"mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-[var(--inkblot-radius-sm)] bg-[var(--inkblot-semantic-color-interactive-primary)]/15",children:jsxRuntimeExports.jsx(Sparkles,{className:"h-3.5 w-3.5 text-[var(--inkblot-semantic-color-interactive-primary)]","aria-hidden":true})}),jsxRuntimeExports.jsx("p",{className:"pt-0.5 text-sm leading-relaxed text-[var(--inkblot-semantic-color-text-secondary)]",children:M.content})]}):M.type==="entity"?N?N("entity"):jsxRuntimeExports.jsx("div",{className:yo,children:"Entity card preview"}):M.type==="intelligence"?N?N("intelligence"):jsxRuntimeExports.jsx("div",{className:yo,children:"Intelligence card preview"}):M.type==="loading"?jsxRuntimeExports.jsxs("div",{className:"flex items-center gap-3",children:[jsxRuntimeExports.jsx("div",{className:"flex h-6 w-6 shrink-0 items-center justify-center rounded-[var(--inkblot-radius-sm)] bg-[var(--inkblot-semantic-color-interactive-primary)]/15",children:jsxRuntimeExports.jsx(Sparkles,{className:"h-3.5 w-3.5 animate-pulse text-[var(--inkblot-semantic-color-interactive-primary)]","aria-hidden":true})}),jsxRuntimeExports.jsxs("div",{className:"flex gap-1",children:[jsxRuntimeExports.jsx("span",{className:"h-1.5 w-1.5 animate-bounce rounded-full bg-[var(--inkblot-semantic-color-text-tertiary)]",style:{animationDelay:"0ms"}}),jsxRuntimeExports.jsx("span",{className:"h-1.5 w-1.5 animate-bounce rounded-full bg-[var(--inkblot-semantic-color-text-tertiary)]",style:{animationDelay:"150ms"}}),jsxRuntimeExports.jsx("span",{className:"h-1.5 w-1.5 animate-bounce rounded-full bg-[var(--inkblot-semantic-color-text-tertiary)]",style:{animationDelay:"300ms"}})]})]}):null;return jsxRuntimeExports.jsxs("section",{className:o("flex h-full flex-col",k),children:[jsxRuntimeExports.jsxs("header",{className:"flex items-center justify-between border-b border-[var(--inkblot-semantic-color-border-default)] px-8 py-5",children:[jsxRuntimeExports.jsxs("div",{children:[jsxRuntimeExports.jsx("h2",{className:"text-lg font-semibold tracking-tight text-[var(--inkblot-semantic-color-text-primary)]",children:t}),jsxRuntimeExports.jsx("p",{className:"mt-0.5 text-xs text-[var(--inkblot-semantic-color-text-tertiary)]",children:e})]}),jsxRuntimeExports.jsxs("div",{className:"flex items-center gap-2 text-xs text-[var(--inkblot-semantic-color-text-tertiary)]",children:[jsxRuntimeExports.jsx("span",{className:"h-1.5 w-1.5 rounded-full bg-[var(--inkblot-semantic-color-status-success)]"}),r]})]}),jsxRuntimeExports.jsx("div",{className:"hide-scrollbar flex-1 overflow-y-auto px-8 py-6",children:jsxRuntimeExports.jsx("div",{className:"mx-auto max-w-3xl space-y-6",children:Wo?n.map(M=>jsxRuntimeExports.jsx("div",{children:s?s(M):Ri(M)},M.id)):O.map(M=>M.role==="user"?jsxRuntimeExports.jsx("div",{className:"flex justify-end",children:jsxRuntimeExports.jsx("div",{className:"max-w-md rounded-2xl rounded-br-sm bg-[var(--inkblot-semantic-color-interactive-secondary)] px-4 py-2.5 text-sm leading-relaxed text-[var(--inkblot-semantic-color-text-primary)]",children:M.content})},M.id):jsxRuntimeExports.jsxs("div",{className:"space-y-4",children:[jsxRuntimeExports.jsxs("div",{className:"flex items-start gap-3",children:[jsxRuntimeExports.jsx("div",{className:"mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-[var(--inkblot-radius-sm)] bg-[var(--inkblot-semantic-color-interactive-primary)]/15",children:jsxRuntimeExports.jsx(Sparkles,{className:"h-3.5 w-3.5 text-[var(--inkblot-semantic-color-interactive-primary)]","aria-hidden":true})}),jsxRuntimeExports.jsx("p",{className:"pt-0.5 text-sm leading-relaxed text-[var(--inkblot-semantic-color-text-secondary)]",children:M.content})]}),M.cards?.length?jsxRuntimeExports.jsx("div",{className:"ml-9 grid gap-4",children:M.cards.map(Xt=>N?jsxRuntimeExports.jsx("div",{children:N(Xt)},Xt):jsxRuntimeExports.jsx("div",{className:yo,children:Xt==="entity"?"Entity card preview":"Intelligence card preview"},Xt))}):null]},M.id))})}),!y&&!Wo?jsxRuntimeExports.jsx("footer",{className:"border-t border-[var(--inkblot-semantic-color-border-default)] px-8 py-4",children:jsxRuntimeExports.jsxs("div",{className:"mx-auto max-w-3xl",children:[jsxRuntimeExports.jsxs("div",{className:"flex items-center gap-3 rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] px-4 py-3",children:[jsxRuntimeExports.jsx(Sparkles,{className:"h-4 w-4 shrink-0 text-[var(--inkblot-semantic-color-text-tertiary)]"}),jsxRuntimeExports.jsx("input",{type:"text",value:W,onChange:M=>q(M.target.value),onKeyDown:M=>{M.key==="Enter"&&ze();},placeholder:a,className:"flex-1 bg-transparent text-sm text-[var(--inkblot-semantic-color-text-primary)] placeholder:text-[var(--inkblot-semantic-color-text-tertiary)] outline-none"}),jsxRuntimeExports.jsx("button",{type:"button",onClick:ze,disabled:!Yt,className:"flex h-8 w-8 items-center justify-center rounded-[var(--inkblot-radius-sm)] bg-[var(--inkblot-semantic-color-interactive-primary)] text-[var(--inkblot-semantic-color-text-inverse)] transition-opacity duration-[var(--inkblot-duration-fast)] disabled:opacity-35","aria-label":"Send",children:jsxRuntimeExports.jsx(Send,{className:"h-3.5 w-3.5"})})]}),jsxRuntimeExports.jsx("p",{className:"mt-2 text-center text-[10px] text-[var(--inkblot-semantic-color-text-tertiary)]",children:i})]})}):jsxRuntimeExports.jsx("footer",{className:"border-t border-[var(--inkblot-semantic-color-border-default)] px-8 py-3",children:jsxRuntimeExports.jsx("p",{className:"text-center text-[10px] text-[var(--inkblot-semantic-color-text-tertiary)]",children:i})})]})}const {useEffect:xm,useRef:hm,useState:sn} = await importShared('react');
function Nm({trigger:t,items:e,className:r}){let[a,i]=sn(false),[n,s]=sn({x:0,y:0}),l=hm(null);xm(()=>{if(!a)return;let d=()=>i(false);return document.addEventListener("click",d),document.addEventListener("contextmenu",d),()=>{document.removeEventListener("click",d),document.removeEventListener("contextmenu",d);}},[a]);let c=d=>{d.preventDefault();let m=l.current?.getBoundingClientRect(),p=m?.left??0,b=m?.top??0;s({x:d.clientX-p,y:d.clientY-b}),i(true);};return jsxRuntimeExports.jsxs("div",{ref:l,className:o("relative w-full",r),onContextMenu:c,children:[t,a&&jsxRuntimeExports.jsx("div",{role:"menu",className:"absolute z-40 min-w-[220px] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] p-[var(--inkblot-spacing-1)] shadow-lg",style:{left:n.x,top:n.y},children:e.map(d=>jsxRuntimeExports.jsxs("button",{type:"button",role:"menuitem",disabled:d.disabled,onClick:()=>{d.onSelect?.(),i(false);},className:o("flex min-h-[var(--inkblot-size-touch-target-min)] w-full items-center justify-between gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-md)] px-[var(--inkblot-spacing-3)] text-sm transition-colors duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)]",d.disabled?"cursor-not-allowed opacity-[var(--inkblot-opacity-disabled)]":"hover:bg-[var(--inkblot-semantic-color-background-tertiary)]",d.danger?"text-[var(--inkblot-semantic-color-status-error)]":"text-[var(--inkblot-semantic-color-text-primary)]"),children:[jsxRuntimeExports.jsxs("span",{className:"flex items-center gap-[var(--inkblot-spacing-2)]",children:[d.icon&&jsxRuntimeExports.jsx("span",{className:"text-[var(--inkblot-semantic-color-text-tertiary)]",children:d.icon}),jsxRuntimeExports.jsx("span",{children:d.label})]}),d.shortcut&&jsxRuntimeExports.jsx("span",{className:"text-xs text-[var(--inkblot-semantic-color-text-tertiary)]",children:d.shortcut})]},d.id))})]})}const {createContext:wm,forwardRef:No,useCallback:ho,useContext:Cm,useEffect:ln,useId:cn,useMemo:Tm,useRef:dn,useState:Pm} = await importShared('react');
const {createPortal:Sm} = await importShared('react-dom');
var pn=wm(null);function wo(){let t=Cm(pn);if(!t)throw new Error("Dialog components must be used within Dialog");return t}function Em({open:t,defaultOpen:e=false,onOpenChange:r,children:a}){let[i,n]=Pm(e),s=t!==void 0,l=s?t:i,c=ho(m=>{s||n(m),r?.(m);},[s,r]),d=Tm(()=>({open:l,setOpen:c}),[l,c]);return jsxRuntimeExports.jsx(pn.Provider,{value:d,children:a})}var bn=No(({className:t,type:e="button",onClick:r,...a},i)=>{let{setOpen:n}=wo();return jsxRuntimeExports.jsx("button",{ref:i,type:e,onClick:s=>{r?.(s),s.defaultPrevented||n(true);},className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center rounded-[var(--inkblot-radius-lg)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)]","bg-[var(--inkblot-semantic-color-interactive-primary)] text-[var(--inkblot-semantic-color-text-inverse)]","hover:bg-[var(--inkblot-semantic-color-interactive-primary-hover)] active:bg-[var(--inkblot-semantic-color-interactive-primary-active)]","focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--inkblot-semantic-color-border-focus)] focus-visible:outline-offset-2","disabled:opacity-[var(--inkblot-opacity-disabled)] disabled:pointer-events-none disabled:cursor-not-allowed","[font:var(--inkblot-semantic-typography-body-medium)]",t),...a})});bn.displayName="DialogTrigger";var un=No(({className:t,children:e,showCloseButton:r=true,initialFocusRef:a,...i},n)=>{let{open:s,setOpen:l}=wo(),c=cn(),d=cn(),m=dn(null),p=dn(null),b=ho(f=>{if(m.current=f,typeof n=="function"){n(f);return}n&&(n.current=f);},[n]),u=ho(()=>{l(false);},[l]);return ln(()=>{if(!s)return;let f=w=>{w.key==="Escape"&&u();};return window.addEventListener("keydown",f),()=>{window.removeEventListener("keydown",f);}},[u,s]),ln(()=>{if(!s)return;p.current=document.activeElement instanceof HTMLElement?document.activeElement:null;let f=a?.current,w=m.current?.querySelector('button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');return (f??w??m.current)?.focus(),()=>{p.current?.focus();}},[a,s]),!s||typeof document>"u"?null:Sm(jsxRuntimeExports.jsxs("div",{className:o("fixed inset-0 z-50 flex items-center justify-center p-[var(--inkblot-spacing-6)]"),children:[jsxRuntimeExports.jsx("button",{type:"button","aria-label":"Close dialog",className:o("absolute inset-0 bg-[var(--inkblot-semantic-color-background-primary)]/70"),onClick:u}),jsxRuntimeExports.jsxs("div",{ref:b,role:"dialog","aria-modal":"true","aria-labelledby":c,"aria-describedby":d,tabIndex:-1,className:o("relative z-10 w-full max-w-[calc(var(--inkblot-size-touch-target-min)*10)] rounded-[var(--inkblot-radius-xl)] border border-[var(--inkblot-semantic-color-border-default)]","bg-[var(--inkblot-semantic-color-background-primary)] p-[var(--inkblot-spacing-6)]","shadow-[var(--inkblot-shadow-lg)]",t),...i,children:[r?jsxRuntimeExports.jsx(Co,{"aria-label":"Close dialog",className:o("absolute right-[var(--inkblot-spacing-4)] top-[var(--inkblot-spacing-4)] rounded-[var(--inkblot-radius-md)] p-[var(--inkblot-spacing-2)]"),children:jsxRuntimeExports.jsx(X,{style:{width:"var(--inkblot-spacing-4)",height:"var(--inkblot-spacing-4)"}})}):null,jsxRuntimeExports.jsx("div",{id:c,className:"sr-only"}),jsxRuntimeExports.jsx("div",{id:d,className:"sr-only"}),e]})]}),document.body)});un.displayName="DialogContent";function Im({className:t,...e}){return jsxRuntimeExports.jsx("div",{className:o("mb-[var(--inkblot-spacing-4)] grid gap-[var(--inkblot-spacing-2)]",t),...e})}function Lm({className:t,...e}){return jsxRuntimeExports.jsx("h2",{className:o("text-[var(--inkblot-semantic-color-text-primary)] [font:var(--inkblot-semantic-typography-heading-small)]",t),...e})}function Am({className:t,...e}){return jsxRuntimeExports.jsx("p",{className:o("text-[var(--inkblot-semantic-color-text-secondary)] [font:var(--inkblot-semantic-typography-body-medium)]",t),...e})}function Dm({className:t,...e}){return jsxRuntimeExports.jsx("div",{className:o("mt-[var(--inkblot-spacing-6)] flex flex-wrap justify-end gap-[var(--inkblot-spacing-3)]",t),...e})}var Co=No(({className:t,type:e="button",onClick:r,...a},i)=>{let{setOpen:n}=wo();return jsxRuntimeExports.jsx("button",{ref:i,type:e,onClick:s=>{r?.(s),s.defaultPrevented||n(false);},className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center rounded-[var(--inkblot-radius-lg)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)]","bg-[var(--inkblot-semantic-color-interactive-secondary)] text-[var(--inkblot-semantic-color-text-primary)]","border border-[var(--inkblot-semantic-color-border-default)]","hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] hover:border-[var(--inkblot-semantic-color-border-strong)]","focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--inkblot-semantic-color-border-focus)] focus-visible:outline-offset-2","[font:var(--inkblot-semantic-typography-body-medium)]",t),...a})});Co.displayName="DialogClose";const {createContext:Rm,forwardRef:Po,useCallback:To,useContext:Hm,useEffect:vn,useMemo:Bm,useRef:fn,useState:Om} = await importShared('react');
const {createPortal:zm} = await importShared('react-dom');
var gn=Rm(null);function So(){let t=Hm(gn);if(!t)throw new Error("Drawer components must be used within Drawer");return t}function Vm({children:t,open:e,defaultOpen:r=false,onOpenChange:a,side:i="right"}){let[n,s]=Om(r),l=e!==void 0,c=l?e:n,d=To(p=>{l||s(p),a?.(p);},[l,a]),m=Bm(()=>({open:c,setOpen:d,side:i}),[c,d,i]);return jsxRuntimeExports.jsx(gn.Provider,{value:m,children:t})}var kn=Po(({className:t,type:e="button",onClick:r,...a},i)=>{let{setOpen:n}=So();return jsxRuntimeExports.jsx("button",{ref:i,type:e,onClick:s=>{r?.(s),s.defaultPrevented||n(true);},className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center rounded-[var(--inkblot-radius-lg)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)]","bg-[var(--inkblot-semantic-color-interactive-primary)] text-[var(--inkblot-semantic-color-text-inverse)]","hover:bg-[var(--inkblot-semantic-color-interactive-primary-hover)] active:bg-[var(--inkblot-semantic-color-interactive-primary-active)]","focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--inkblot-semantic-color-border-focus)] focus-visible:outline-offset-2",t),...a})});kn.displayName="DrawerTrigger";var yn=Po(({className:t,children:e,initialFocusRef:r,...a},i)=>{let{open:n,setOpen:s,side:l}=So(),c=fn(null),d=fn(null),m=To(b=>{if(c.current=b,typeof i=="function"){i(b);return}i&&(i.current=b);},[i]),p=To(()=>{s(false);},[s]);return vn(()=>{if(!n)return;let b=u=>{u.key==="Escape"&&p();};return window.addEventListener("keydown",b),()=>{window.removeEventListener("keydown",b);}},[p,n]),vn(()=>{if(!n)return;d.current=document.activeElement instanceof HTMLElement?document.activeElement:null;let b=r?.current,u=c.current?.querySelector('button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');return (b??u??c.current)?.focus(),()=>{d.current?.focus();}},[r,n]),!n||typeof document>"u"?null:zm(jsxRuntimeExports.jsxs("div",{className:"fixed inset-0 z-50",children:[jsxRuntimeExports.jsx("button",{type:"button","aria-label":"Close drawer",className:"absolute inset-0 bg-[var(--inkblot-semantic-color-background-primary)]/70",onClick:p}),jsxRuntimeExports.jsx("div",{ref:m,role:"dialog","aria-modal":"true",tabIndex:-1,className:o("absolute top-0 h-full w-full max-w-[calc(var(--inkblot-size-touch-target-min)*7)] border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-primary)] p-[var(--inkblot-spacing-6)] shadow-[var(--inkblot-shadow-lg)]",l==="right"?"right-0 border-l":"left-0 border-r",t),...a,children:e})]}),document.body)});yn.displayName="DrawerContent";function Gm({className:t,...e}){return jsxRuntimeExports.jsx("div",{className:o("mb-[var(--inkblot-spacing-4)] grid gap-[var(--inkblot-spacing-2)]",t),...e})}function Km({className:t,...e}){return jsxRuntimeExports.jsx("h2",{className:o("text-[var(--inkblot-semantic-color-text-primary)] [font:var(--inkblot-semantic-typography-heading-small)]",t),...e})}function Wm({className:t,...e}){return jsxRuntimeExports.jsx("p",{className:o("text-[var(--inkblot-semantic-color-text-secondary)] [font:var(--inkblot-semantic-typography-body-medium)]",t),...e})}function _m({className:t,...e}){return jsxRuntimeExports.jsx("div",{className:o("mt-[var(--inkblot-spacing-6)] flex flex-wrap justify-end gap-[var(--inkblot-spacing-3)]",t),...e})}var xn=Po(({className:t,type:e="button",onClick:r,children:a,...i},n)=>{let{setOpen:s}=So();return jsxRuntimeExports.jsx("button",{ref:n,type:e,onClick:l=>{r?.(l),l.defaultPrevented||s(false);},className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-lg)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)]","bg-[var(--inkblot-semantic-color-interactive-secondary)] text-[var(--inkblot-semantic-color-text-primary)]","border border-[var(--inkblot-semantic-color-border-default)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)]",t),...i,children:a??jsxRuntimeExports.jsx(X,{style:{width:"var(--inkblot-spacing-4)",height:"var(--inkblot-spacing-4)"}})})});xn.displayName="DrawerClose";const {createContext:$m,forwardRef:Mo,useCallback:jm,useContext:qm,useEffect:Ym,useMemo:Xm,useRef:Zm,useState:Qm} = await importShared('react');
var hn=$m(null);function Eo(){let t=qm(hn);if(!t)throw new Error("DropdownMenu components must be used within DropdownMenu");return t}function tp({children:t,open:e,defaultOpen:r=false,onOpenChange:a}){let[i,n]=Qm(r),s=Zm(null),l=e!==void 0,c=l?e:i,d=jm(p=>{l||n(p),a?.(p);},[l,a]);Ym(()=>{if(!c)return;let p=u=>{let f=u.target;f&&s.current&&!s.current.contains(f)&&d(false);},b=u=>{u.key==="Escape"&&d(false);};return window.addEventListener("pointerdown",p),window.addEventListener("keydown",b),()=>{window.removeEventListener("pointerdown",p),window.removeEventListener("keydown",b);}},[c,d]);let m=Xm(()=>({open:c,setOpen:d,containerRef:s}),[c,d]);return jsxRuntimeExports.jsx(hn.Provider,{value:m,children:jsxRuntimeExports.jsx("div",{ref:s,className:"relative inline-flex",children:t})})}var Nn=Mo(({className:t,type:e="button",showChevron:r=true,onClick:a,children:i,...n},s)=>{let{open:l,setOpen:c}=Eo();return jsxRuntimeExports.jsxs("button",{ref:s,type:e,"aria-haspopup":"menu","aria-expanded":l,onClick:d=>{a?.(d),d.defaultPrevented||c(!l);},className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)]","bg-[var(--inkblot-semantic-color-interactive-secondary)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)]","text-[var(--inkblot-semantic-color-text-primary)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)]","focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--inkblot-semantic-color-border-focus)] focus-visible:outline-offset-2","[font:var(--inkblot-semantic-typography-body-medium)]",t),...n,children:[i,r?jsxRuntimeExports.jsx(ChevronDown,{style:{width:"var(--inkblot-spacing-4)",height:"var(--inkblot-spacing-4)"}}):null]})});Nn.displayName="DropdownMenuTrigger";var wn=Mo(({className:t,...e},r)=>{let{open:a}=Eo();return a?jsxRuntimeExports.jsx("div",{ref:r,role:"menu",className:o("absolute right-0 top-[calc(100%+var(--inkblot-spacing-2))] z-40 min-w-[calc(var(--inkblot-size-touch-target-min)*4)] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)]","bg-[var(--inkblot-semantic-color-background-primary)] p-[var(--inkblot-spacing-2)] shadow-[var(--inkblot-shadow-md)]",t),...e}):null});wn.displayName="DropdownMenuContent";var Cn=Mo(({className:t,type:e="button",icon:r,onClick:a,children:i,...n},s)=>{let{setOpen:l}=Eo();return jsxRuntimeExports.jsxs("button",{ref:s,type:e,role:"menuitem",onClick:c=>{a?.(c),c.defaultPrevented||l(false);},className:o("flex min-h-[var(--inkblot-size-touch-target-min)] w-full items-center gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-md)] px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-2)]","text-left text-[var(--inkblot-semantic-color-text-primary)] hover:bg-[var(--inkblot-semantic-color-background-secondary)]","focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--inkblot-semantic-color-border-focus)] focus-visible:outline-offset-0","[font:var(--inkblot-semantic-typography-body-medium)]",t),...n,children:[r,i]})});Cn.displayName="DropdownMenuItem";function ep({className:t,...e}){return jsxRuntimeExports.jsx("div",{className:o("my-[var(--inkblot-spacing-2)] border-b border-[var(--inkblot-semantic-color-border-default)]",t),...e})}const {useMemo:Pn,useState:rp} = await importShared('react');
var Mn=[{type:"heading",label:"Heading",icon:Type},{type:"text",label:"Text",icon:Type},{type:"image",label:"Image",icon:Image},{type:"button",label:"Button",icon:Square},{type:"divider",label:"Divider",icon:Minus},{type:"columns",label:"2 Columns",icon:Columns2}],mp={heading:"Your Heading Here",text:"Write your content here. Click to edit this text block.",image:"https://placehold.co/600x200",button:"Click Me",divider:"",columns:"Column 1 | Column 2"};function EC({blocks:t,onBlocksChange:e,availableBlockTypes:r,editingId:a,onEditingIdChange:i,onAddBlock:n,onDeleteBlock:s,onMoveBlock:l,onBlockContentChange:c,readOnly:d=false,className:m}){let[p,b]=rp(null),u=a!==void 0,f=u?a:p,w=v=>{u||b(v),i?.(v);},h=Pn(()=>!r||r.length===0?Mn:Mn.filter(v=>r.includes(v.type)),[r]),g=Pn(()=>t.reduce((v,x,C)=>(v[x.id]=C,v),{}),[t]),P=v=>{if(d)return;let x={id:`block-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,type:v,content:mp[v]};e([...t,x]),n?.(v,x);},N=(v,x)=>{d||(e(t.map(C=>C.id===v?{...C,content:x}:C)),c?.(v,x));},y=v=>{d||(e(t.filter(x=>x.id!==v)),s?.(v));},k=(v,x)=>{if(d)return;let C=g[v],S=C+x;if(S<0||S>=t.length)return;let D=[...t],[E]=D.splice(C,1);D.splice(S,0,E),e(D),l?.(v,x);};return jsxRuntimeExports.jsxs("section",{className:o("flex gap-4",m),children:[jsxRuntimeExports.jsxs("aside",{className:"w-44 shrink-0",children:[jsxRuntimeExports.jsx("span",{className:"text-[10px] uppercase tracking-wide text-[var(--inkblot-semantic-color-text-tertiary)]",children:"Blocks"}),jsxRuntimeExports.jsx("div",{className:"mt-2 space-y-1",children:h.map(v=>jsxRuntimeExports.jsxs("button",{type:"button",onClick:()=>P(v.type),disabled:d,className:"flex w-full items-center gap-2 rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)] px-3 py-2 text-xs text-[var(--inkblot-semantic-color-text-primary)] transition-colors duration-[var(--inkblot-duration-fast)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)]",children:[jsxRuntimeExports.jsx(v.icon,{className:"h-3.5 w-3.5 text-[var(--inkblot-semantic-color-text-tertiary)]"}),v.label]},v.type))})]}),jsxRuntimeExports.jsx("div",{className:"glass min-h-[400px] flex-1 rounded-[var(--inkblot-radius-lg)] p-6",children:t.length===0?jsxRuntimeExports.jsxs("div",{className:"flex h-full flex-col items-center justify-center gap-3 text-center",children:[jsxRuntimeExports.jsx(MousePointerClick,{className:"h-8 w-8 text-[var(--inkblot-semantic-color-text-tertiary)]/40"}),jsxRuntimeExports.jsxs("div",{children:[jsxRuntimeExports.jsx("p",{className:"text-sm text-[var(--inkblot-semantic-color-text-tertiary)]",children:"Drop blocks here to build your email"}),jsxRuntimeExports.jsx("p",{className:"mt-1 text-[10px] text-[var(--inkblot-semantic-color-text-tertiary)]/60",children:"or use AI to generate a full layout"})]})]}):jsxRuntimeExports.jsx("div",{className:"space-y-2",children:t.map((v,x)=>jsxRuntimeExports.jsxs("article",{className:"group flex items-start gap-2",children:[jsxRuntimeExports.jsx("div",{className:"pt-1 text-[var(--inkblot-semantic-color-text-tertiary)]",children:jsxRuntimeExports.jsx(GripVertical,{className:"h-3.5 w-3.5"})}),jsxRuntimeExports.jsxs("div",{className:"flex-1 rounded-[var(--inkblot-radius-md)] border border-transparent p-3 transition-colors duration-[var(--inkblot-duration-fast)] group-hover:border-[var(--inkblot-semantic-color-border-default)]",children:[v.type==="heading"?jsxRuntimeExports.jsx("h2",{contentEditable:!d&&f===v.id,suppressContentEditableWarning:true,onClick:()=>{d||w(v.id);},onBlur:C=>{N(v.id,C.currentTarget.textContent??""),w(null);},className:"cursor-text text-xl font-bold text-[var(--inkblot-semantic-color-text-primary)] outline-none",children:v.content}):null,v.type==="text"?jsxRuntimeExports.jsx("p",{contentEditable:!d&&f===v.id,suppressContentEditableWarning:true,onClick:()=>{d||w(v.id);},onBlur:C=>{N(v.id,C.currentTarget.textContent??""),w(null);},className:"cursor-text text-sm leading-relaxed text-[var(--inkblot-semantic-color-text-secondary)] outline-none",children:v.content}):null,v.type==="image"?jsxRuntimeExports.jsx("div",{className:"flex h-32 items-center justify-center overflow-hidden rounded-[var(--inkblot-radius-md)] bg-[var(--inkblot-semantic-color-background-tertiary)]",children:jsxRuntimeExports.jsx(Image,{className:"h-8 w-8 text-[var(--inkblot-semantic-color-text-tertiary)]/50"})}):null,v.type==="button"?jsxRuntimeExports.jsx("div",{className:"flex justify-center",children:jsxRuntimeExports.jsx("span",{contentEditable:!d&&f===v.id,suppressContentEditableWarning:true,onClick:()=>{d||w(v.id);},onBlur:C=>{N(v.id,C.currentTarget.textContent??""),w(null);},className:"cursor-text rounded-[var(--inkblot-radius-md)] bg-[var(--inkblot-semantic-color-interactive-primary)] px-6 py-2.5 text-sm font-medium text-[var(--inkblot-semantic-color-text-inverse)] outline-none",children:v.content})}):null,v.type==="divider"?jsxRuntimeExports.jsx("hr",{className:"my-2 border-[var(--inkblot-semantic-color-border-default)]"}):null,v.type==="columns"?jsxRuntimeExports.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[jsxRuntimeExports.jsx("div",{className:"rounded-[var(--inkblot-radius-md)] bg-[var(--inkblot-semantic-color-background-tertiary)] p-4 text-center text-sm text-[var(--inkblot-semantic-color-text-tertiary)]",children:"Column 1"}),jsxRuntimeExports.jsx("div",{className:"rounded-[var(--inkblot-radius-md)] bg-[var(--inkblot-semantic-color-background-tertiary)] p-4 text-center text-sm text-[var(--inkblot-semantic-color-text-tertiary)]",children:"Column 2"})]}):null]}),jsxRuntimeExports.jsxs("div",{className:"flex flex-col gap-1 opacity-0 transition-opacity duration-[var(--inkblot-duration-fast)] group-hover:opacity-100",children:[jsxRuntimeExports.jsx("button",{type:"button",onClick:()=>k(v.id,-1),disabled:d||x===0,className:"rounded-[var(--inkblot-radius-sm)] p-1 text-[var(--inkblot-semantic-color-text-tertiary)] transition-colors duration-[var(--inkblot-duration-fast)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] disabled:opacity-30","aria-label":"Move up",children:jsxRuntimeExports.jsx(ChevronUp,{className:"h-3 w-3"})}),jsxRuntimeExports.jsx("button",{type:"button",onClick:()=>k(v.id,1),disabled:d||x===t.length-1,className:"rounded-[var(--inkblot-radius-sm)] p-1 text-[var(--inkblot-semantic-color-text-tertiary)] transition-colors duration-[var(--inkblot-duration-fast)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] disabled:opacity-30","aria-label":"Move down",children:jsxRuntimeExports.jsx(ChevronDown,{className:"h-3 w-3"})}),jsxRuntimeExports.jsx("button",{type:"button",onClick:()=>y(v.id),disabled:d,className:"rounded-[var(--inkblot-radius-sm)] p-1 text-[var(--inkblot-semantic-color-status-error)] transition-colors duration-[var(--inkblot-duration-fast)] hover:bg-[var(--inkblot-semantic-color-status-error)]/10","aria-label":"Delete block",children:jsxRuntimeExports.jsx(Trash2,{className:"h-3 w-3"})})]})]},v.id))})})]})}const {forwardRef:pp} = await importShared('react');
var Ln=pp(({className:t,...e},r)=>jsxRuntimeExports.jsx("form",{ref:r,className:o("grid gap-[var(--inkblot-spacing-4)] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-primary)] p-[var(--inkblot-spacing-5)]",t),...e}));Ln.displayName="Form";function bp({className:t,label:e,hint:r,error:a,children:i,requiredIndicator:n,...s}){return jsxRuntimeExports.jsxs("div",{className:o("grid gap-[var(--inkblot-spacing-2)]",t),...s,children:[e?jsxRuntimeExports.jsxs("p",{className:"text-[var(--inkblot-semantic-color-text-primary)] [font:var(--inkblot-semantic-typography-body-medium)]",children:[e,n?jsxRuntimeExports.jsx("span",{className:"ml-[var(--inkblot-spacing-1)] text-[var(--inkblot-semantic-color-status-error)]",children:"*"}):null]}):null,i,a?jsxRuntimeExports.jsx("p",{className:"text-[var(--inkblot-semantic-color-status-error)] [font:var(--inkblot-semantic-typography-body-small)]",children:a}):r?jsxRuntimeExports.jsx("p",{className:"text-[var(--inkblot-semantic-color-text-secondary)] [font:var(--inkblot-semantic-typography-body-small)]",children:r}):null]})}function up({className:t,...e}){return jsxRuntimeExports.jsx("div",{className:o("mt-[var(--inkblot-spacing-2)] flex flex-wrap justify-end gap-[var(--inkblot-spacing-3)]",t),...e})}const {useEffect:vp,useRef:fp} = await importShared('react');
var gp=[{id:"1",label:"Acme Corp",kind:"org",x:400,y:250,score:82},{id:"2",label:"TechVentures",kind:"org",x:220,y:140,score:65},{id:"3",label:"DataFlow Labs",kind:"org",x:600,y:160,score:45},{id:"4",label:"Jane Smith",kind:"person",x:300,y:380,score:90},{id:"5",label:"Mark Johnson",kind:"person",x:520,y:370,score:72},{id:"6",label:"GlobalTech",kind:"org",x:160,y:300,score:38},{id:"7",label:"Sarah Lee",kind:"person",x:650,y:310,score:55}],kp=[{from:"1",to:"2",strength:.8},{from:"1",to:"3",strength:.5},{from:"1",to:"4",strength:.9},{from:"1",to:"5",strength:.7},{from:"2",to:"6",strength:.4},{from:"3",to:"7",strength:.6},{from:"4",to:"5",strength:.3},{from:"6",to:"4",strength:.5}];function yp(t,e,r,a){return t>=70?e:t>=50?r:a}function Ht(t,e){for(let r of e){let a=t.getPropertyValue(r).trim();if(a)return a}return ""}function Io(t,e,r){if(e){t.font=e;return}t.font=r;}function KC({title:t="Entity Graph",subtitle:e,nodes:r=gp,edges:a=kp,className:i}){let n=fp(null);vp(()=>{let l=n.current;if(!l)return;let c=l.getContext("2d");if(!c)return;let d=()=>{let m=l.getBoundingClientRect(),p=window.devicePixelRatio||1;l.width=m.width*p,l.height=m.height*p,c.setTransform(p,0,0,p,0,0),c.clearRect(0,0,m.width,m.height);let b=getComputedStyle(document.documentElement),u=Ht(b,["--inkblot-semantic-color-border-default","--inkblot-semantic-color-border-strong"]),f=Ht(b,["--inkblot-semantic-color-text-tertiary","--inkblot-semantic-color-text-secondary"]),w=Ht(b,["--inkblot-semantic-color-background-secondary","--inkblot-semantic-color-background-primary"]),h=Ht(b,["--inkblot-semantic-color-status-success","--inkblot-semantic-color-interactive-primary"]),g=Ht(b,["--inkblot-semantic-color-status-warning","--inkblot-semantic-color-status-info"]),P=Ht(b,["--inkblot-semantic-color-status-error","--inkblot-semantic-color-status-warning"]),N=Ht(b,["--inkblot-semantic-typography-body-small","--inkblot-semantic-typography-body-medium"]),y=Ht(b,["--inkblot-semantic-typography-body-medium","--inkblot-semantic-typography-body-small"]),k=c.font;a.forEach(v=>{let x=r.find(S=>S.id===v.from),C=r.find(S=>S.id===v.to);!x||!C||(c.beginPath(),c.moveTo(x.x,x.y),c.lineTo(C.x,C.y),c.strokeStyle=u,c.globalAlpha=Math.min(1,Math.max(0,v.strength*.45)),c.lineWidth=Math.max(1,v.strength*2),c.stroke(),c.globalAlpha=1);}),r.forEach(v=>{let x=yp(v.score,h,g,P),C=v.kind==="org"?28:22;c.beginPath(),c.arc(v.x,v.y,C+8,0,Math.PI*2),c.fillStyle=x,c.globalAlpha=.08,c.fill(),c.globalAlpha=1,c.beginPath(),c.arc(v.x,v.y,C,0,Math.PI*2),c.fillStyle=w,c.strokeStyle=x,c.globalAlpha=.7,c.lineWidth=1.5,c.fill(),c.stroke(),c.globalAlpha=1,c.fillStyle=x,Io(c,N,k),c.textAlign="center",c.textBaseline="middle",c.fillText(v.kind==="org"?"\u2B21":"\u25CF",v.x,v.y),c.fillStyle=f,Io(c,y,k),c.fillText(v.label,v.x,v.y+C+16),c.fillStyle=x,c.globalAlpha=.8,Io(c,N,k),c.fillText(String(v.score),v.x,v.y+C+28),c.globalAlpha=1;});};return d(),window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[a,r]);let s=e??`Relationship intelligence \xB7 ${r.length} nodes \xB7 ${a.length} edges`;return jsxRuntimeExports.jsxs("section",{className:o("flex h-full flex-col",i),children:[jsxRuntimeExports.jsxs("header",{className:"flex items-center justify-between border-b border-[var(--inkblot-semantic-color-border-default)] px-8 py-5",children:[jsxRuntimeExports.jsxs("div",{children:[jsxRuntimeExports.jsx("h2",{className:"text-lg font-semibold tracking-tight text-[var(--inkblot-semantic-color-text-primary)]",children:t}),jsxRuntimeExports.jsx("p",{className:"mt-0.5 text-xs text-[var(--inkblot-semantic-color-text-tertiary)]",children:s})]}),jsxRuntimeExports.jsxs("div",{className:"flex items-center gap-4 text-xs text-[var(--inkblot-semantic-color-text-tertiary)]",children:[jsxRuntimeExports.jsxs("span",{className:"flex items-center gap-1.5",children:[jsxRuntimeExports.jsx("span",{className:"h-2 w-2 rounded-full bg-[var(--inkblot-semantic-color-status-success)]"}),"Orgs"]}),jsxRuntimeExports.jsxs("span",{className:"flex items-center gap-1.5",children:[jsxRuntimeExports.jsx("span",{className:"h-2 w-2 rounded-full bg-[var(--inkblot-semantic-color-status-warning)]"}),"People"]})]})]}),jsxRuntimeExports.jsx("div",{className:"relative flex-1",children:jsxRuntimeExports.jsx("canvas",{ref:n,className:"h-full w-full"})})]})}const {useCallback:xp,useEffect:hp,useMemo:Np,useState:Lo} = await importShared('react');
var Sp=[{target:"[data-tour='sidebar']",title:"Navigation Sidebar",description:"Access all CRM modules from this sidebar. Each icon represents a different module.",position:"right"},{target:"[data-tour='canvas']",title:"AI Command Canvas",description:"This is your AI-powered command center where you can orchestrate tasks and workflows.",position:"bottom"},{target:"[data-tour='event-feed']",title:"Real-Time Event Feed",description:"Follow live system activity like stage updates, invoices, and communication events.",position:"left"},{target:"[data-tour='system-status']",title:"System Status",description:"This indicator confirms platform health and connectivity.",position:"right"}];function XC({steps:t=Sp,open:e,defaultOpen:r=true,onOpenChange:a,stepIndex:i,defaultStepIndex:n=0,onStepIndexChange:s,onComplete:l,className:c}){let[d,m]=Lo(r),[p,b]=Lo(n),[u,f]=Lo(null),w=e??d,h=i??p,g=t[h],P=h===t.length-1,N=S=>{e===void 0&&m(S),a?.(S);},y=S=>{let D=Math.min(Math.max(S,0),Math.max(t.length-1,0));i===void 0&&b(D),s?.(D);},k=xp(()=>{let S=document.querySelector(g.target);if(!S){f(null);return}f(S.getBoundingClientRect());},[g.target]);hp(()=>(k(),window.addEventListener("resize",k),window.addEventListener("scroll",k,true),()=>{window.removeEventListener("resize",k),window.removeEventListener("scroll",k,true);}),[k]);let v=()=>{if(P){N(false),l();return}y(h+1);},x=()=>{y(h-1);},C=Np(()=>{if(!u)return {top:"50%",left:"50%",transform:"translate(-50%, -50%)"};let S=16,D=320;return g.position==="right"?{top:u.top+u.height/2,left:u.right+S,transform:"translateY(-50%)"}:g.position==="left"?{top:u.top+u.height/2,left:u.left-D-S,transform:"translateY(-50%)"}:g.position==="top"?{top:u.top-S,left:u.left+u.width/2,transform:"translate(-50%, -100%)"}:{top:u.bottom+S,left:u.left+u.width/2,transform:"translateX(-50%)"}},[g.position,u]);return w?jsxRuntimeExports.jsxs("div",{className:o("fixed inset-0 z-[200]",c),children:[u?jsxRuntimeExports.jsx("div",{className:"pointer-events-none absolute rounded-[var(--inkblot-radius-lg)] border-2 border-[var(--inkblot-semantic-color-interactive-primary)]/50",style:{top:u.top-6,left:u.left-6,width:u.width+12,height:u.height+12,boxShadow:"0 0 0 9999px var(--inkblot-semantic-color-background-inverse), var(--inkblot-shadow-lg)"}}):jsxRuntimeExports.jsx("div",{className:"absolute inset-0 bg-[var(--inkblot-semantic-color-background-inverse)]/70"}),jsxRuntimeExports.jsxs("div",{style:{...C,position:"absolute",width:320,zIndex:210},className:"rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] p-5 shadow-[var(--inkblot-shadow-lg)]",children:[jsxRuntimeExports.jsxs("div",{className:"mb-3 flex items-center justify-between",children:[jsxRuntimeExports.jsxs("span",{className:"text-[10px] uppercase tracking-wide text-[var(--inkblot-semantic-color-text-tertiary)]",children:["Step ",h+1," of ",t.length]}),jsxRuntimeExports.jsx("button",{type:"button",onClick:()=>{N(false),l();},className:"rounded-[var(--inkblot-radius-sm)] p-1 text-[var(--inkblot-semantic-color-text-tertiary)] transition-colors duration-[var(--inkblot-duration-fast)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)]","aria-label":"Close tour",children:jsxRuntimeExports.jsx(X,{className:"h-3 w-3"})})]}),jsxRuntimeExports.jsx("h3",{className:"mb-1.5 text-sm font-semibold text-[var(--inkblot-semantic-color-text-primary)]",children:g.title}),jsxRuntimeExports.jsx("p",{className:"text-xs leading-relaxed text-[var(--inkblot-semantic-color-text-tertiary)]",children:g.description}),jsxRuntimeExports.jsx("div",{className:"mb-3 mt-4 flex gap-1",children:t.map((S,D)=>jsxRuntimeExports.jsx("span",{className:o("h-1 flex-1 rounded-full",D<=h?"bg-[var(--inkblot-semantic-color-interactive-primary)]":"bg-[var(--inkblot-semantic-color-background-tertiary)]")},`${D}-progress`))}),jsxRuntimeExports.jsxs("div",{className:"flex items-center justify-between",children:[jsxRuntimeExports.jsxs("button",{type:"button",onClick:x,disabled:h===0,className:"flex items-center gap-1 text-xs text-[var(--inkblot-semantic-color-text-tertiary)] transition-opacity duration-[var(--inkblot-duration-fast)] disabled:opacity-0",children:[jsxRuntimeExports.jsx(ArrowLeft,{className:"h-3 w-3"}),"Back"]}),jsxRuntimeExports.jsx("button",{type:"button",onClick:v,className:"flex items-center gap-1.5 rounded-[var(--inkblot-radius-md)] bg-[var(--inkblot-semantic-color-interactive-primary)] px-4 py-2 text-xs font-medium text-[var(--inkblot-semantic-color-text-inverse)]",children:P?jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:[jsxRuntimeExports.jsx(Check,{className:"h-3 w-3"}),"Get Started"]}):jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:["Next",jsxRuntimeExports.jsx(ArrowRight,{className:"h-3 w-3"})]})})]})]})]}):null}const {createContext:Mp,forwardRef:Dn,useContext:Ep,useMemo:Ip,useRef:Lp,useState:Ap} = await importShared('react');
var Rn=Mp(null);function Hn(){let t=Ep(Rn);if(!t)throw new Error("HoverCard components must be used within HoverCard");return t}function Dp({children:t,openDelay:e=120,closeDelay:r=120}){let[a,i]=Ap(false),n=Lp(null),s=Ip(()=>({open:a,setOpen:i,openDelay:e,closeDelay:r,timeoutRef:n}),[a,e,r]);return jsxRuntimeExports.jsx(Rn.Provider,{value:s,children:jsxRuntimeExports.jsx("div",{className:"relative inline-flex",children:t})})}var Bn=Dn(({className:t,onMouseEnter:e,onMouseLeave:r,onFocus:a,onBlur:i,...n},s)=>{let{setOpen:l,openDelay:c,closeDelay:d,timeoutRef:m}=Hn();return jsxRuntimeExports.jsx("div",{ref:s,tabIndex:0,onMouseEnter:p=>{e?.(p),m.current&&window.clearTimeout(m.current),m.current=window.setTimeout(()=>l(true),c);},onMouseLeave:p=>{r?.(p),m.current&&window.clearTimeout(m.current),m.current=window.setTimeout(()=>l(false),d);},onFocus:p=>{a?.(p),l(true);},onBlur:p=>{i?.(p),l(false);},className:o(t),...n})});Bn.displayName="HoverCardTrigger";var On=Dn(({className:t,onMouseEnter:e,onMouseLeave:r,...a},i)=>{let{open:n,setOpen:s,closeDelay:l,timeoutRef:c}=Hn();return n?jsxRuntimeExports.jsx("div",{ref:i,role:"dialog",onMouseEnter:d=>{e?.(d),c.current&&window.clearTimeout(c.current),s(true);},onMouseLeave:d=>{r?.(d),c.current&&window.clearTimeout(c.current),c.current=window.setTimeout(()=>s(false),l);},className:o("absolute left-0 top-[calc(100%+var(--inkblot-spacing-2))] z-40 min-w-[calc(var(--inkblot-size-touch-target-min)*4)] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)]","bg-[var(--inkblot-semantic-color-background-primary)] p-[var(--inkblot-spacing-4)] shadow-[var(--inkblot-shadow-md)]",t),...a}):null});On.displayName="HoverCardContent";const {forwardRef:Rp,useMemo:Hp,useRef:Bp,useState:Op} = await importShared('react');
var Fn=Rp(({className:t,disabled:e,length:r=6,value:a,defaultValue:i="",onValueChange:n,containerProps:s,...l},c)=>{let[d,m]=Op(i.slice(0,r)),p=Bp([]),b=a!==void 0,u=b?a.slice(0,r):d,f=Hp(()=>Array.from({length:r},(y,k)=>u[k]??""),[u,r]),w=y=>{let k=y.slice(0,r);b||m(k),n?.(k);},h=y=>{let k=p.current[y];k?.focus(),k?.select();},g=(y,k)=>{let v=k.replace(/[^0-9A-Za-z]/g,"").slice(0,1),x=f.map((C,S)=>S===y?v:C);w(x.join("")),v&&y<r-1&&h(y+1);},P=(y,k)=>{if(k.key==="Backspace"&&!f[y]&&y>0){let v=f.map((x,C)=>C===y-1?"":x);w(v.join("")),h(y-1);}k.key==="ArrowLeft"&&y>0&&(k.preventDefault(),h(y-1)),k.key==="ArrowRight"&&y<r-1&&(k.preventDefault(),h(y+1));};return jsxRuntimeExports.jsx("div",{ref:c,onPaste:y=>{y.preventDefault();let k=y.clipboardData.getData("text").replace(/[^0-9A-Za-z]/g,"").slice(0,r);k&&(w(k),h(Math.min(k.length,r-1)));},className:o("flex items-center gap-[var(--inkblot-spacing-2)]",t,s?.className),...s,children:f.map((y,k)=>jsxRuntimeExports.jsx("input",{ref:v=>{p.current[k]=v;},type:"text",inputMode:"numeric",maxLength:1,value:y,disabled:e,onChange:v=>g(k,v.target.value),onKeyDown:v=>P(k,v),className:o("min-h-[var(--inkblot-size-touch-target-min)] w-full rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)]","bg-[var(--inkblot-semantic-color-background-secondary)] px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-2)]","text-center text-[var(--inkblot-semantic-color-text-primary)] [font:var(--inkblot-semantic-typography-heading-small)]","focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--inkblot-semantic-color-border-focus)] focus-visible:outline-offset-2","disabled:opacity-[var(--inkblot-opacity-disabled)] disabled:pointer-events-none"),...l},`otp-slot-${k}`))})});Fn.displayName="InputOtp";var zp=[{label:"Revenue Confidence",value:82,tone:"success"},{label:"Churn Risk",value:23,tone:"warning",inverted:true},{label:"Momentum",value:67,tone:"primary"}];function vT({title:t="Intelligence Scores",items:e=zp,className:r}){return jsxRuntimeExports.jsxs("article",{className:o("glass rounded-[var(--inkblot-radius-lg)] p-5",r),children:[jsxRuntimeExports.jsx("h3",{className:"mb-4 text-xs font-medium uppercase tracking-wide text-[var(--inkblot-semantic-color-text-tertiary)]",children:t}),jsxRuntimeExports.jsx("div",{className:"grid grid-cols-3 gap-6",children:e.map(a=>jsxRuntimeExports.jsx(an,{label:a.label,value:a.value,tone:a.tone,color:a.color,inverted:a.inverted},a.label))})]})}const {forwardRef:Vp} = await importShared('react');
var Vn=Vp(({className:t,children:e,requiredIndicator:r,...a},i)=>jsxRuntimeExports.jsxs("label",{ref:i,className:o("inline-flex items-center gap-[var(--inkblot-spacing-1)] text-[var(--inkblot-semantic-color-text-primary)] [font:var(--inkblot-semantic-typography-body-medium)]",t),...a,children:[e,r?jsxRuntimeExports.jsx("span",{className:"text-[var(--inkblot-semantic-color-status-error)]",children:"*"}):null]}));Vn.displayName="Label";const {createContext:Gn,forwardRef:Re,useContext:Kn,useMemo:Wn,useRef:Wp,useState:_p} = await importShared('react');
var _n=Gn(null);function Do(){let t=Kn(_n);if(!t)throw new Error("Menubar components must be used within Menubar");return t}var Un=Gn(null);function $n(){let t=Kn(Un);if(!t)throw new Error("Menubar menu components must be used within MenubarMenu");return t}var jn=Re(({className:t,...e},r)=>{let[a,i]=_p(null),n=Wn(()=>({openMenuId:a,setOpenMenuId:i}),[a]);return jsxRuntimeExports.jsx(_n.Provider,{value:n,children:jsxRuntimeExports.jsx("div",{ref:r,className:o("flex items-center gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-primary)] p-[var(--inkblot-spacing-2)]",t),...e})})});jn.displayName="Menubar";function $p({id:t,className:e,...r}){let a=Wn(()=>({menuId:t}),[t]);return jsxRuntimeExports.jsx(Un.Provider,{value:a,children:jsxRuntimeExports.jsx("div",{className:o("relative inline-flex",e),...r})})}var qn=Re(({className:t,type:e="button",showChevron:r=true,onClick:a,children:i,...n},s)=>{let{openMenuId:l,setOpenMenuId:c}=Do(),{menuId:d}=$n(),m=l===d;return jsxRuntimeExports.jsxs("button",{ref:s,type:e,"aria-haspopup":"menu","aria-expanded":m,onClick:p=>{a?.(p),p.defaultPrevented||c(m?null:d);},className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-md)] px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-2)]","[font:var(--inkblot-semantic-typography-body-medium)]",m?"bg-[var(--inkblot-semantic-color-interactive-primary)] text-[var(--inkblot-semantic-color-text-inverse)]":"text-[var(--inkblot-semantic-color-text-primary)] hover:bg-[var(--inkblot-semantic-color-background-secondary)]",t),...n,children:[i,r?jsxRuntimeExports.jsx(ChevronDown,{style:{width:"var(--inkblot-spacing-4)",height:"var(--inkblot-spacing-4)"}}):null]})});qn.displayName="MenubarTrigger";var Yn=Re(({className:t,...e},r)=>{let{openMenuId:a}=Do(),{menuId:i}=$n();return a!==i?null:jsxRuntimeExports.jsx("div",{ref:r,role:"menu",className:o("absolute left-0 top-[calc(100%+var(--inkblot-spacing-2))] z-40 min-w-[calc(var(--inkblot-size-touch-target-min)*4)] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)]","bg-[var(--inkblot-semantic-color-background-primary)] p-[var(--inkblot-spacing-2)] shadow-[var(--inkblot-shadow-md)]",t),...e})});Yn.displayName="MenubarContent";var Xn=Re(({className:t,type:e="button",icon:r,...a},i)=>jsxRuntimeExports.jsxs("button",{ref:i,type:e,role:"menuitem",className:o("flex min-h-[var(--inkblot-size-touch-target-min)] w-full items-center gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-md)] px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-2)]","text-left text-[var(--inkblot-semantic-color-text-primary)] hover:bg-[var(--inkblot-semantic-color-background-secondary)]","[font:var(--inkblot-semantic-typography-body-medium)]",t),...a,children:[r,a.children]}));Xn.displayName="MenubarItem";function jp({className:t,...e}){return jsxRuntimeExports.jsx("div",{className:o("my-[var(--inkblot-spacing-2)] border-b border-[var(--inkblot-semantic-color-border-default)]",t),...e})}var Zn=Re(({className:t,...e},r)=>{let{setOpenMenuId:a}=Do(),i=Wp(null);return jsxRuntimeExports.jsx("div",{ref:n=>{i.current=n,typeof r=="function"?r(n):r&&(r.current=n);},onPointerDown:n=>{i.current?.contains(n.target)&&a(null);},className:o(t),...e})});Zn.displayName="MenubarCloseZone";function qp({items:t,className:e,onItemSelect:r}){return jsxRuntimeExports.jsx("nav",{"aria-label":"Navigation menu",className:o("flex flex-wrap items-center gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-primary)] p-[var(--inkblot-spacing-2)]",e),children:t.map(a=>jsxRuntimeExports.jsx(Yp,{item:a,onSelect:()=>r?.(a)},a.id))})}function Yp({item:t,onSelect:e,className:r,...a}){let i=o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center gap-[var(--inkblot-spacing-2)] rounded-[var(--inkblot-radius-md)] px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-2)]","[font:var(--inkblot-semantic-typography-body-medium)]",t.active?"bg-[var(--inkblot-semantic-color-interactive-primary)] text-[var(--inkblot-semantic-color-text-inverse)]":"text-[var(--inkblot-semantic-color-text-primary)] hover:bg-[var(--inkblot-semantic-color-background-secondary)]",t.disabled&&"pointer-events-none opacity-[var(--inkblot-opacity-disabled)]",r);return t.href?jsxRuntimeExports.jsxs("a",{href:t.href,"aria-current":t.active?"page":void 0,className:i,onClick:()=>e?.(),...a,children:[t.icon,t.label,t.active?null:jsxRuntimeExports.jsx(ChevronRight,{style:{width:"var(--inkblot-spacing-4)",height:"var(--inkblot-spacing-4)"}})]}):jsxRuntimeExports.jsxs("button",{type:"button","aria-current":t.active?"page":void 0,disabled:t.disabled,className:i,onClick:()=>e?.(),children:[t.icon,t.label,t.active?null:jsxRuntimeExports.jsx(ChevronRight,{style:{width:"var(--inkblot-spacing-4)",height:"var(--inkblot-spacing-4)"}})]})}const {useMemo:Xp,useState:ei} = await importShared('react');
var sb=[{id:"company",question:"What's your company name?",subtitle:"We'll personalize your workspace around your brand.",icon:Building2,type:"input",field:"companyName",placeholder:"e.g. Acme Corporation"},{id:"size",question:"How many employees does your company have?",subtitle:"This helps us tailor the right features for your team size.",icon:Users,type:"select",field:"companySize",options:[{value:"1-10",label:"1-10"},{value:"11-50",label:"11-50"},{value:"51-200",label:"51-200"},{value:"201-1000",label:"201-1,000"},{value:"1000+",label:"1,000+"}]},{id:"industry",question:"What industry are you in?",subtitle:"We'll pre-configure pipelines and templates for your sector.",icon:Briefcase,type:"select",field:"industry",options:[{value:"saas",label:"SaaS / Software"},{value:"agency",label:"Agency / Consulting"},{value:"ecommerce",label:"E-Commerce"},{value:"fintech",label:"Fintech"},{value:"healthcare",label:"Healthcare"},{value:"other",label:"Other"}]},{id:"role",question:"What's your role?",subtitle:"So we can surface the most relevant modules first.",icon:Target,type:"select",field:"role",options:[{value:"founder",label:"Founder / CEO"},{value:"sales",label:"Sales Leader"},{value:"marketing",label:"Marketing"},{value:"ops",label:"Operations"},{value:"other",label:"Other"}]},{id:"goals",question:"What do you want to achieve?",subtitle:"Select all that apply. We'll prioritize these in your dashboard.",icon:Target,type:"multi-select",field:"goals",options:[{value:"pipeline",label:"Manage Sales Pipeline"},{value:"contacts",label:"Organize Contacts"},{value:"email",label:"Email Campaigns"},{value:"invoicing",label:"Invoicing"},{value:"reporting",label:"Analytics & Reporting"},{value:"automation",label:"Workflow Automation"}]},{id:"source",question:"How did you hear about us?",subtitle:"Helps us improve our outreach.",icon:Megaphone,type:"select",field:"source",options:[{value:"google",label:"Google Search"},{value:"social",label:"Social Media"},{value:"referral",label:"Friend / Colleague"},{value:"event",label:"Conference / Event"},{value:"other",label:"Other"}]},{id:"website",question:"What's your company website?",subtitle:"Optional, we'll try to auto-import your branding.",icon:Globe,type:"input",field:"website",placeholder:"e.g. https://acme.com"}];function KT({onComplete:t,steps:e=sb,value:r,defaultValue:a,onValueChange:i,stepIndex:n,defaultStepIndex:s=0,onStepIndexChange:l,onCancel:c,showSkip:d=true,className:m}){let[p,b]=ei(s),[u,f]=ei(a??{}),w=n!==void 0,h=r!==void 0,g=w?n:p,P=h?r:u,N=e[g],y=P[N.field]??(N.type==="multi-select"?[]:""),k=g===e.length-1,v=Xp(()=>N.type==="multi-select"?y.length>0:N.id==="website"?true:typeof y=="string"&&y.trim().length>0,[y,N.id,N.type]),x=I=>{let O=Math.min(Math.max(I,0),Math.max(e.length-1,0));w||b(O),l?.(O);},C=I=>{h||f(I),i?.(I);},S=()=>x(g-1),D=()=>{if(k){t(P);return}x(g+1);},E=(I,O)=>{C({...P,[I]:O});},F=(I,O)=>{let L=P[I]??[],W=L.includes(O)?L.filter($=>$!==O):[...L,O];E(I,W);};return jsxRuntimeExports.jsxs("section",{className:o("fixed inset-0 z-[100] flex items-center justify-center bg-[var(--inkblot-semantic-color-background-primary)]",m),children:[jsxRuntimeExports.jsxs("div",{className:"absolute inset-0 overflow-hidden",children:[jsxRuntimeExports.jsx("div",{className:"absolute left-1/4 top-1/4 h-96 w-96 rounded-full bg-[var(--inkblot-semantic-color-interactive-primary)]/5 blur-[120px]"}),jsxRuntimeExports.jsx("div",{className:"absolute bottom-1/4 right-1/4 h-96 w-96 rounded-full bg-[var(--inkblot-semantic-color-status-warning)]/5 blur-[120px]"})]}),jsxRuntimeExports.jsxs("div",{className:"relative w-full max-w-lg px-6",children:[jsxRuntimeExports.jsxs("header",{className:"mb-12 flex items-center justify-center gap-2",children:[jsxRuntimeExports.jsx("span",{className:"flex h-10 w-10 items-center justify-center rounded-[var(--inkblot-radius-lg)] bg-[var(--inkblot-semantic-color-interactive-primary)]",children:jsxRuntimeExports.jsx(Command,{className:"h-5 w-5 text-[var(--inkblot-semantic-color-text-inverse)]"})}),jsxRuntimeExports.jsx("span",{className:"text-lg font-semibold tracking-tight text-[var(--inkblot-semantic-color-text-primary)]",children:"Citron OS"})]}),jsxRuntimeExports.jsx("div",{className:"mb-10 flex gap-1",children:e.map((I,O)=>jsxRuntimeExports.jsx("span",{className:o("h-0.5 flex-1 rounded-full",O<g?"bg-[var(--inkblot-semantic-color-interactive-primary)]":O===g?"bg-[var(--inkblot-semantic-color-interactive-primary)]/60":"bg-[var(--inkblot-semantic-color-background-tertiary)]")},I.id))}),jsxRuntimeExports.jsxs("div",{className:"space-y-6",children:[jsxRuntimeExports.jsxs("div",{children:[jsxRuntimeExports.jsx("div",{className:"mb-4 flex h-10 w-10 items-center justify-center rounded-[var(--inkblot-radius-lg)] bg-[var(--inkblot-semantic-color-interactive-secondary)]",children:jsxRuntimeExports.jsx(N.icon,{className:"h-5 w-5 text-[var(--inkblot-semantic-color-text-primary)]"})}),jsxRuntimeExports.jsx("h2",{className:"text-xl font-semibold tracking-tight text-[var(--inkblot-semantic-color-text-primary)]",children:N.question}),jsxRuntimeExports.jsx("p",{className:"mt-1 text-sm text-[var(--inkblot-semantic-color-text-tertiary)]",children:N.subtitle})]}),N.type==="input"?jsxRuntimeExports.jsx("input",{autoFocus:true,value:y||"",onChange:I=>E(N.field,I.target.value),placeholder:N.placeholder,onKeyDown:I=>{I.key==="Enter"&&v&&D();},className:"w-full rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] px-5 py-3.5 text-sm text-[var(--inkblot-semantic-color-text-primary)] placeholder:text-[var(--inkblot-semantic-color-text-tertiary)] outline-none"}):null,N.type==="select"?jsxRuntimeExports.jsx("div",{className:"grid grid-cols-2 gap-2",children:N.options?.map(I=>jsxRuntimeExports.jsx("button",{type:"button",onClick:()=>E(N.field,I.value),className:o("rounded-[var(--inkblot-radius-lg)] border px-4 py-3 text-left text-sm transition-colors duration-[var(--inkblot-duration-fast)]",y===I.value?"border-[var(--inkblot-semantic-color-interactive-primary)] bg-[var(--inkblot-semantic-color-interactive-primary)]/10 text-[var(--inkblot-semantic-color-text-primary)]":"border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] text-[var(--inkblot-semantic-color-text-tertiary)] hover:bg-[var(--inkblot-semantic-color-background-tertiary)]"),children:I.label},I.value))}):null,N.type==="multi-select"?jsxRuntimeExports.jsx("div",{className:"grid grid-cols-2 gap-2",children:N.options?.map(I=>{let O=y.includes(I.value);return jsxRuntimeExports.jsxs("button",{type:"button",onClick:()=>F(N.field,I.value),className:o("flex items-center gap-2 rounded-[var(--inkblot-radius-lg)] border px-4 py-3 text-left text-sm transition-colors duration-[var(--inkblot-duration-fast)]",O?"border-[var(--inkblot-semantic-color-interactive-primary)] bg-[var(--inkblot-semantic-color-interactive-primary)]/10 text-[var(--inkblot-semantic-color-text-primary)]":"border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] text-[var(--inkblot-semantic-color-text-tertiary)] hover:bg-[var(--inkblot-semantic-color-background-tertiary)]"),children:[jsxRuntimeExports.jsx("span",{className:o("flex h-4 w-4 shrink-0 items-center justify-center rounded-[var(--inkblot-radius-sm)] border",O?"border-[var(--inkblot-semantic-color-interactive-primary)] bg-[var(--inkblot-semantic-color-interactive-primary)]":"border-[var(--inkblot-semantic-color-border-default)]"),children:O?jsxRuntimeExports.jsx(Check,{className:"h-2.5 w-2.5 text-[var(--inkblot-semantic-color-text-inverse)]"}):null}),I.label]},I.value)})}):null]}),jsxRuntimeExports.jsxs("footer",{className:"mt-10 flex items-center justify-between",children:[jsxRuntimeExports.jsxs("button",{type:"button",onClick:S,disabled:g===0,className:"flex items-center gap-1.5 rounded-[var(--inkblot-radius-md)] px-4 py-2 text-xs text-[var(--inkblot-semantic-color-text-tertiary)] transition-opacity duration-[var(--inkblot-duration-fast)] disabled:opacity-0",children:[jsxRuntimeExports.jsx(ArrowLeft,{className:"h-3 w-3"}),"Back"]}),jsxRuntimeExports.jsxs("div",{className:"flex items-center gap-3",children:[!k&&d?jsxRuntimeExports.jsx("button",{type:"button",onClick:c??D,className:"text-xs text-[var(--inkblot-semantic-color-text-tertiary)]",children:"Skip"}):null,jsxRuntimeExports.jsx("button",{type:"button",onClick:D,disabled:!v,className:"flex items-center gap-2 rounded-[var(--inkblot-radius-lg)] bg-[var(--inkblot-semantic-color-interactive-primary)] px-5 py-2.5 text-xs font-medium text-[var(--inkblot-semantic-color-text-inverse)] transition-opacity duration-[var(--inkblot-duration-fast)] disabled:opacity-40",children:k?jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:[jsxRuntimeExports.jsx(Sparkles,{className:"h-3 w-3"}),"Launch Citron OS"]}):jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:["Continue",jsxRuntimeExports.jsx(ArrowRight,{className:"h-3 w-3"})]})})]})]})]})]})}function db({page:t,totalPages:e,onPageChange:r,className:a}){let i=Array.from({length:e},(n,s)=>s+1);return jsxRuntimeExports.jsxs("nav",{"aria-label":"Pagination",className:o("flex items-center gap-[var(--inkblot-spacing-2)]",a),children:[jsxRuntimeExports.jsx("button",{type:"button","aria-label":"Previous page",disabled:t<=1,onClick:()=>r(Math.max(t-1,1)),className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)] px-[var(--inkblot-spacing-3)]","bg-[var(--inkblot-semantic-color-interactive-secondary)] text-[var(--inkblot-semantic-color-text-primary)]","hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] disabled:opacity-[var(--inkblot-opacity-disabled)] disabled:pointer-events-none"),children:jsxRuntimeExports.jsx(ChevronLeft,{style:{width:"var(--inkblot-spacing-4)",height:"var(--inkblot-spacing-4)"}})}),i.map(n=>{let s=n===t;return jsxRuntimeExports.jsx("button",{type:"button",onClick:()=>r(n),"aria-current":s?"page":void 0,className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] min-w-[var(--inkblot-size-touch-target-min)] items-center justify-center rounded-[var(--inkblot-radius-md)] px-[var(--inkblot-spacing-3)]","[font:var(--inkblot-semantic-typography-body-medium)]",s?"bg-[var(--inkblot-semantic-color-interactive-primary)] text-[var(--inkblot-semantic-color-text-inverse)]":"bg-[var(--inkblot-semantic-color-interactive-secondary)] text-[var(--inkblot-semantic-color-text-primary)] hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)]"),children:n},`page-${n}`)}),jsxRuntimeExports.jsx("button",{type:"button","aria-label":"Next page",disabled:t>=e,onClick:()=>r(Math.min(t+1,e)),className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center rounded-[var(--inkblot-radius-md)] border border-[var(--inkblot-semantic-color-border-default)] px-[var(--inkblot-spacing-3)]","bg-[var(--inkblot-semantic-color-interactive-secondary)] text-[var(--inkblot-semantic-color-text-primary)]","hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)] disabled:opacity-[var(--inkblot-opacity-disabled)] disabled:pointer-events-none"),children:jsxRuntimeExports.jsx(ChevronRight,{style:{width:"var(--inkblot-spacing-4)",height:"var(--inkblot-spacing-4)"}})})]})}const {createContext:pb,forwardRef:Ro,useCallback:bb,useContext:ub,useEffect:vb,useMemo:fb,useRef:gb,useState:kb} = await importShared('react');
var ai=pb(null);function Ho(){let t=ub(ai);if(!t)throw new Error("Popover components must be used within Popover");return t}function yb({children:t,open:e,defaultOpen:r=false,onOpenChange:a}){let[i,n]=kb(r),s=gb(null),l=e!==void 0,c=l?e:i,d=bb(p=>{l||n(p),a?.(p);},[l,a]);vb(()=>{if(!c)return;let p=u=>{let f=u.target;f&&s.current&&!s.current.contains(f)&&d(false);},b=u=>{u.key==="Escape"&&d(false);};return window.addEventListener("pointerdown",p),window.addEventListener("keydown",b),()=>{window.removeEventListener("pointerdown",p),window.removeEventListener("keydown",b);}},[c,d]);let m=fb(()=>({open:c,setOpen:d,containerRef:s}),[c,d]);return jsxRuntimeExports.jsx(ai.Provider,{value:m,children:jsxRuntimeExports.jsx("div",{ref:s,className:"relative inline-flex",children:t})})}var ni=Ro(({className:t,type:e="button",onClick:r,...a},i)=>{let{open:n,setOpen:s}=Ho();return jsxRuntimeExports.jsx("button",{ref:i,type:e,"aria-haspopup":"dialog","aria-expanded":n,onClick:l=>{r?.(l),l.defaultPrevented||s(!n);},className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)]","bg-[var(--inkblot-semantic-color-interactive-secondary)] px-[var(--inkblot-spacing-4)] py-[var(--inkblot-spacing-2)] text-[var(--inkblot-semantic-color-text-primary)]","hover:bg-[var(--inkblot-semantic-color-interactive-secondary-hover)]","[font:var(--inkblot-semantic-typography-body-medium)]",t),...a})});ni.displayName="PopoverTrigger";var ii=Ro(({className:t,...e},r)=>{let{open:a}=Ho();return a?jsxRuntimeExports.jsx("div",{ref:r,role:"dialog",className:o("absolute left-0 top-[calc(100%+var(--inkblot-spacing-2))] z-40 min-w-[calc(var(--inkblot-size-touch-target-min)*4)] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)]","bg-[var(--inkblot-semantic-color-background-primary)] p-[var(--inkblot-spacing-4)] shadow-[var(--inkblot-shadow-md)]",t),...e}):null});ii.displayName="PopoverContent";var si=Ro(({className:t,type:e="button",onClick:r,...a},i)=>{let{setOpen:n}=Ho();return jsxRuntimeExports.jsx("button",{ref:i,type:e,onClick:s=>{r?.(s),s.defaultPrevented||n(false);},className:o("inline-flex min-h-[var(--inkblot-size-touch-target-min)] items-center justify-center rounded-[var(--inkblot-radius-md)] px-[var(--inkblot-spacing-3)] py-[var(--inkblot-spacing-2)]","bg-[var(--inkblot-semantic-color-interactive-secondary)] text-[var(--inkblot-semantic-color-text-primary)]",t),...a})});si.displayName="PopoverClose";const {forwardRef:xb} = await importShared('react');
var li=xb(({className:t,value:e,max:r=100,showValueLabel:a=false,...i},n)=>{let s=Math.max(0,Math.min(e/r,1)),l=`${Math.round(s*100)}%`;return jsxRuntimeExports.jsxs("div",{ref:n,className:o("grid gap-[var(--inkblot-spacing-2)]",t),...i,children:[jsxRuntimeExports.jsx("div",{className:"h-[var(--inkblot-spacing-2)] overflow-hidden rounded-[var(--inkblot-radius-full)] bg-[var(--inkblot-semantic-color-background-secondary)]",children:jsxRuntimeExports.jsx("div",{className:"h-full rounded-[var(--inkblot-radius-full)] bg-[var(--inkblot-semantic-color-interactive-primary)] transition-[width] duration-[var(--inkblot-duration-fast)] ease-[var(--inkblot-easing-default)]",style:{width:l}})}),a?jsxRuntimeExports.jsx("p",{className:"text-[var(--inkblot-semantic-color-text-secondary)] [font:var(--inkblot-semantic-typography-body-small)]",children:l}):null]})});li.displayName="Progress";const {forwardRef:di,useState:Nb} = await importShared('react');
var mi=di(({className:t,options:e,value:r,defaultValue:a,onValueChange:i,name:n="radio-group",...s},l)=>{let[c,d]=Nb(a??""),m=r!==void 0,p=m?r:c,b=u=>{m||d(u),i?.(u);};return jsxRuntimeExports.jsx("div",{ref:l,role:"radiogroup",className:o("grid gap-[var(--inkblot-spacing-2)]",t),...s,children:e.map(u=>jsxRuntimeExports.jsxs("label",{className:o("flex cursor-pointer items-start gap-[var(--inkblot-spacing-3)] rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] p-[var(--inkblot-spacing-3)]","bg-[var(--inkblot-semantic-color-background-primary)] hover:bg-[var(--inkblot-semantic-color-background-secondary)]",u.disabled&&"pointer-events-none opacity-[var(--inkblot-opacity-disabled)]"),children:[jsxRuntimeExports.jsx(Oo,{type:"radio",name:n,value:u.value,checked:p===u.value,disabled:u.disabled,onChange:()=>b(u.value)}),jsxRuntimeExports.jsxs("span",{className:"grid gap-[var(--inkblot-spacing-1)]",children:[jsxRuntimeExports.jsx("span",{className:"text-[var(--inkblot-semantic-color-text-primary)] [font:var(--inkblot-semantic-typography-body-medium)]",children:u.label}),u.description?jsxRuntimeExports.jsx("span",{className:"text-[var(--inkblot-semantic-color-text-secondary)] [font:var(--inkblot-semantic-typography-body-small)]",children:u.description}):null]})]},u.value))})});mi.displayName="RadioGroup";var Oo=di(({className:t,...e},r)=>jsxRuntimeExports.jsx("input",{ref:r,className:o("mt-[var(--inkblot-spacing-1)] h-[var(--inkblot-spacing-4)] w-[var(--inkblot-spacing-4)] border-[var(--inkblot-semantic-color-border-default)] text-[var(--inkblot-semantic-color-interactive-primary)]",t),...e}));Oo.displayName="RadioGroupItem";const {useMemo:wb,useState:Cb} = await importShared('react');
function Sb({primary:t,secondary:e,direction:r="horizontal",defaultPrimarySize:a=50,minPrimarySize:i=20,minSecondarySize:n=20,className:s}){let[l,c]=Cb(a),d=r==="horizontal",m=wb(()=>d?{gridTemplateColumns:`${l}fr auto ${100-l}fr`}:{gridTemplateRows:`${l}fr auto ${100-l}fr`},[d,l]),p=(b,u)=>{let f=u.getBoundingClientRect(),w=d?(b.x-f.left)/f.width*100:(b.y-f.top)/f.height*100,h=100-n,g=Math.min(h,Math.max(i,w));c(g);};return jsxRuntimeExports.jsxs("div",{className:o("grid h-full w-full overflow-hidden rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-primary)]",s),style:m,children:[jsxRuntimeExports.jsx("div",{className:"min-h-0 min-w-0 overflow-auto p-[var(--inkblot-spacing-3)]",children:t}),jsxRuntimeExports.jsx("div",{className:o(d?"w-[var(--inkblot-spacing-2)]":"h-[var(--inkblot-spacing-2)]","bg-[var(--inkblot-semantic-color-border-default)]"),children:jsxRuntimeExports.jsx("button",{type:"button","aria-label":"Resize panels",className:o("flex h-full w-full items-center justify-center bg-[var(--inkblot-semantic-color-background-secondary)] text-[var(--inkblot-semantic-color-text-secondary)]","hover:bg-[var(--inkblot-semantic-color-background-tertiary)] active:bg-[var(--inkblot-semantic-color-background-secondary)]"),onPointerDown:b=>{let u=b.currentTarget.closest("div")?.parentElement;if(!u)return;p({x:b.clientX,y:b.clientY},u);let f=h=>{p({x:h.clientX,y:h.clientY},u);},w=()=>{window.removeEventListener("pointermove",f),window.removeEventListener("pointerup",w);};window.addEventListener("pointermove",f),window.addEventListener("pointerup",w);},children:d?jsxRuntimeExports.jsx(GripVertical,{style:{width:"var(--inkblot-spacing-4)",height:"var(--inkblot-spacing-4)"}}):jsxRuntimeExports.jsx(GripHorizontal,{style:{width:"var(--inkblot-spacing-4)",height:"var(--inkblot-spacing-4)"}})})}),jsxRuntimeExports.jsx("div",{className:"min-h-0 min-w-0 overflow-auto p-[var(--inkblot-spacing-3)]",children:e})]})}const {forwardRef:Eb} = await importShared('react');
