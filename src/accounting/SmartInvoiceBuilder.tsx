...
export default function SmartInvoiceBuilder() {
  ...
  return (
    <div className="h-full min-w-0 max-w-full overflow-y-auto hide-scrollbar pb-[max(2.5rem,env(safe-area-inset-bottom,0px))]">
      <div className="max-w-[1280px] mx-auto w-full min-w-0 px-3 min-[400px]:px-4 sm:px-6 lg:px-8 py-5 sm:py-8 pb-8 sm:pb-12 box-border">
        <header className="mb-5 sm:mb-6 flex flex-wrap items-start sm:items-center gap-2 sm:gap-3 min-w-0">
          <Link
              ...
              <div className="space-y-3">
                ...
                {addLinePickerOpen && (
                  <div className="rounded-[var(--inkblot-radius-lg)] border border-[var(--inkblot-semantic-color-border-default)] bg-[var(--inkblot-semantic-color-background-secondary)] p-[var(--inkblot-spacing-4)] space-y-[var(--inkblot-spacing-3)]">
                    ...
                    />
                    <Button type="button" variant="secondary" className="w-full sm:w-auto h-8 text-xs" onClick={() => setAddLinePickerOpen(false)}>
                      Cancel
                    </Button>
                  </div>
                )}
